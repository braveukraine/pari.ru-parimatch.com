...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        ...
        Lio/grpc/SynchronizationContext$b;
    }
.end annotation
...
.method public constructor <init>(Ljava/lang/Thread$UncaughtExceptionHandler;)V
    ...
    iput-object v0, p0, Lio/grpc/SynchronizationContext;->e:Ljava/util/Queue;
    ...
    iput-object v0, p0, Lio/grpc/SynchronizationContext;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    iput-object p1, p0, Lio/grpc/SynchronizationContext;->d:Ljava/lang/Thread$UncaughtExceptionHandler;
...
.method public final drain()V
    ...
    .line 1
    :cond_0
    iget-object v0, p0, Lio/grpc/SynchronizationContext;->f:Ljava/util/concurrent/atomic/AtomicReference;
    ...
    :goto_0
    :try_start_0
    iget-object v0, p0, Lio/grpc/SynchronizationContext;->e:Ljava/util/Queue;
    ...
    .line 4
    :try_start_2
    iget-object v1, p0, Lio/grpc/SynchronizationContext;->d:Ljava/lang/Thread$UncaughtExceptionHandler;
    ...
    .line 7
    iget-object v1, p0, Lio/grpc/SynchronizationContext;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public final schedule(Ljava/lang/Runnable;JLjava/util/concurrent/TimeUnit;Ljava/util/concurrent/ScheduledExecutorService;)Lio/grpc/SynchronizationContext$ScheduledHandle;
    ...
    invoke-direct {v0, p1}, Lio/grpc/SynchronizationContext$b;-><init>(Ljava/lang/Runnable;)V

    .line 2
    new-instance v1, Lio/grpc/SynchronizationContext$a;

    invoke-direct {v1, p0, v0, p1}, Lio/grpc/SynchronizationContext$a;-><init>(Lio/grpc/SynchronizationContext;Lio/grpc/SynchronizationContext$b;Ljava/lang/Runnable;)V
    ...
    invoke-direct {p2, v0, p1, p3}, Lio/grpc/SynchronizationContext$ScheduledHandle;-><init>(Lio/grpc/SynchronizationContext$b;Ljava/util/concurrent/ScheduledFuture;Lio/grpc/SynchronizationContext$a;)V
