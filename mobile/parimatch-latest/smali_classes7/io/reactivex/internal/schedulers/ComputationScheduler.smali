...
# static fields
.field public static final g:Lio/reactivex/internal/schedulers/ComputationScheduler$b;

.field public static final h:Lio/reactivex/internal/schedulers/RxThreadFactory;

.field public static final i:I

.field public static final j:Lio/reactivex/internal/schedulers/ComputationScheduler$c;
...
.method public static constructor <clinit>()V
    ...
    :cond_1
    :goto_0
    sput v0, Lio/reactivex/internal/schedulers/ComputationScheduler;->i:I
    ...
    sput-object v0, Lio/reactivex/internal/schedulers/ComputationScheduler;->j:Lio/reactivex/internal/schedulers/ComputationScheduler$c;
    ...
    sput-object v3, Lio/reactivex/internal/schedulers/ComputationScheduler;->h:Lio/reactivex/internal/schedulers/RxThreadFactory;
    ...
    sput-object v0, Lio/reactivex/internal/schedulers/ComputationScheduler;->g:Lio/reactivex/internal/schedulers/ComputationScheduler$b;
...
.method public constructor <init>()V
    ...
    .line 1
    sget-object v0, Lio/reactivex/internal/schedulers/ComputationScheduler;->h:Lio/reactivex/internal/schedulers/RxThreadFactory;
...
.method public constructor <init>(Ljava/util/concurrent/ThreadFactory;)V
    ...
    .line 3
    iput-object p1, p0, Lio/reactivex/internal/schedulers/ComputationScheduler;->e:Ljava/util/concurrent/ThreadFactory;

    .line 4
    new-instance p1, Ljava/util/concurrent/atomic/AtomicReference;

    sget-object v0, Lio/reactivex/internal/schedulers/ComputationScheduler;->g:Lio/reactivex/internal/schedulers/ComputationScheduler$b;

    invoke-direct {p1, v0}, Ljava/util/concurrent/atomic/AtomicReference;-><init>(Ljava/lang/Object;)V

    iput-object p1, p0, Lio/reactivex/internal/schedulers/ComputationScheduler;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public createWorker()Lio/reactivex/Scheduler$Worker;
    ...
    iget-object v1, p0, Lio/reactivex/internal/schedulers/ComputationScheduler;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public createWorkers(ILio/reactivex/internal/schedulers/SchedulerMultiWorkerSupport$WorkerCallback;)V
    ...
    .line 2
    iget-object v0, p0, Lio/reactivex/internal/schedulers/ComputationScheduler;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public shutdown()V
    ...
    .line 2
    sget-object v1, Lio/reactivex/internal/schedulers/ComputationScheduler;->g:Lio/reactivex/internal/schedulers/ComputationScheduler$b;
    ...
    .line 3
    :cond_1
    iget-object v2, p0, Lio/reactivex/internal/schedulers/ComputationScheduler;->f:Ljava/util/concurrent/atomic/AtomicReference;
...
.method public start()V
    ...
    sget v1, Lio/reactivex/internal/schedulers/ComputationScheduler;->i:I

    iget-object v2, p0, Lio/reactivex/internal/schedulers/ComputationScheduler;->e:Ljava/util/concurrent/ThreadFactory;
    ...
    sget-object v2, Lio/reactivex/internal/schedulers/ComputationScheduler;->g:Lio/reactivex/internal/schedulers/ComputationScheduler$b;
