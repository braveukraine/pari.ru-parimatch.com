...
.method public constructor <init>(Ljava/util/concurrent/Callable;Lio/reactivex/functions/Function;Lio/reactivex/functions/Consumer;Z)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->d:Ljava/util/concurrent/Callable;

    .line 3
    iput-object p2, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->e:Lio/reactivex/functions/Function;

    .line 4
    iput-object p3, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->f:Lio/reactivex/functions/Consumer;

    .line 5
    iput-boolean p4, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->g:Z
...
.method public subscribeActual(Lio/reactivex/MaybeObserver;)V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->d:Ljava/util/concurrent/Callable;
    ...
    .line 2
    :try_start_1
    iget-object v1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->e:Lio/reactivex/functions/Function;
    ...
    iget-object v3, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->f:Lio/reactivex/functions/Consumer;

    iget-boolean v4, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->g:Z
    ...
    .line 5
    iget-boolean v2, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->g:Z

    if-eqz v2, :cond_0

    .line 6
    :try_start_2
    iget-object v2, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->f:Lio/reactivex/functions/Consumer;
    ...
    .line 10
    iget-boolean p1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->g:Z

    if-nez p1, :cond_1

    .line 11
    :try_start_3
    iget-object p1, p0, Lio/reactivex/internal/operators/maybe/MaybeUsing;->f:Lio/reactivex/functions/Consumer;
