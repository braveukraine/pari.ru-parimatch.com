...
.method public constructor <init>(Ljava/lang/Iterable;Lio/reactivex/functions/Function;IZ)V
    ...
    .line 8
    iput-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->e:[Lorg/reactivestreams/Publisher;

    .line 9
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->f:Ljava/lang/Iterable;

    .line 10
    iput-object p2, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->g:Lio/reactivex/functions/Function;

    .line 11
    iput p3, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->h:I

    .line 12
    iput-boolean p4, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->i:Z
...
.method public constructor <init>([Lorg/reactivestreams/Publisher;Lio/reactivex/functions/Function;IZ)V
    ...
    .line 2
    iput-object p1, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->e:[Lorg/reactivestreams/Publisher;
...
.method public subscribeActual(Lorg/reactivestreams/Subscriber;)V
    ...
    .line 1
    iget-object v0, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->e:[Lorg/reactivestreams/Publisher;
    ...
    .line 2
    :try_start_0
    iget-object v2, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->f:Ljava/lang/Iterable;
    ...
    .line 18
    :cond_4
    new-instance v9, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$a;

    iget-object v4, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->g:Lio/reactivex/functions/Function;

    iget v6, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->h:I

    iget-boolean v7, p0, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest;->i:Z
    ...
    .line 20
    iget-object p1, v9, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$a;->subscribers:[Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$b;

    :goto_2
    if-ge v1, v8, :cond_6

    .line 21
    iget-boolean v2, v9, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$a;->done:Z

    if-nez v2, :cond_6

    iget-boolean v2, v9, Lio/reactivex/internal/operators/flowable/FlowableCombineLatest$a;->cancelled:Z
