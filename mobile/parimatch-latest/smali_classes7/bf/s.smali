...
.method public static final getValue(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 1
    invoke-static {p0, p1}, Lbf/q;->getOrImplicitDefaultNullable(Ljava/util/Map;Ljava/lang/Object;)Ljava/lang/Object;
...
.method public static final varargs linkedMapOf([Lkotlin/Pair;)Ljava/util/LinkedHashMap;
    ...
    invoke-static {p0, v0}, Lbf/s;->toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final minus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    .line 2
    invoke-static {p0}, Lbf/s;->toMutableMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lbf/s;->optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 2
    :cond_0
    invoke-static {p0}, Lbf/r;->toSingletonMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final plus(Ljava/util/Map;Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lbf/s;->toMap(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lbf/s;->putAll(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final plus(Ljava/util/Map;Lkotlin/sequences/Sequence;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lbf/s;->putAll(Ljava/util/Map;Lkotlin/sequences/Sequence;)V

    invoke-static {v0}, Lbf/s;->optimizeReadOnlyMap(Ljava/util/Map;)Ljava/util/Map;
...
.method public static final plus(Ljava/util/Map;[Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p1}, Lbf/s;->toMap([Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {v0, p1}, Lbf/s;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
...
.method public static final toMap(Ljava/lang/Iterable;)Ljava/util/Map;
    ...
    invoke-static {p0, v1}, Lbf/s;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    invoke-static {p0}, Lbf/r;->mapOf(Lkotlin/Pair;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lbf/s;->toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap(Ljava/lang/Iterable;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 7
    invoke-static {p1, p0}, Lbf/s;->putAll(Ljava/util/Map;Ljava/lang/Iterable;)V
...
.method public static final toMap(Lkotlin/sequences/Sequence;)Ljava/util/Map;
    ...
    invoke-static {p0, v0}, Lbf/s;->toMap(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;
...
.method public static final toMap(Lkotlin/sequences/Sequence;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 14
    invoke-static {p1, p0}, Lbf/s;->putAll(Ljava/util/Map;Lkotlin/sequences/Sequence;)V
...
.method public static final toMap([Lkotlin/Pair;Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 12
    invoke-static {p1, p0}, Lbf/s;->putAll(Ljava/util/Map;[Lkotlin/Pair;)V
