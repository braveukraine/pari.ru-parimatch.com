...
.field public i:Lorg/bouncycastle/x509/X509AttributeCertificate;
...
.method public constructor <init>()V
    ...
    iput-boolean v0, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->d:Z

    iput-boolean v0, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->e:Z

    const/4 v1, 0x0

    iput-object v1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->f:Ljava/math/BigInteger;

    iput-object v1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->g:[B

    iput-boolean v0, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->h:Z
...
.method public clone()Ljava/lang/Object;
    ...
    iget-boolean v1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->d:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->d:Z
    ...
    iget-object v1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->f:Ljava/math/BigInteger;

    iput-object v1, v0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->f:Ljava/math/BigInteger;

    iget-object v1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->i:Lorg/bouncycastle/x509/X509AttributeCertificate;

    iput-object v1, v0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->i:Lorg/bouncycastle/x509/X509AttributeCertificate;

    iget-boolean v1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->h:Z

    iput-boolean v1, v0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->h:Z

    iget-object v1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->g:[B

    invoke-static {v1}, Lorg/bouncycastle/util/Arrays;->clone([B)[B

    move-result-object v1

    iput-object v1, v0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->g:[B
...
.method public getAttrCertificateChecking()Lorg/bouncycastle/x509/X509AttributeCertificate;
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->i:Lorg/bouncycastle/x509/X509AttributeCertificate;
...
.method public getIssuingDistributionPoint()[B
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->g:[B
...
.method public getMaxBaseCRLNumber()Ljava/math/BigInteger;
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->f:Ljava/math/BigInteger;
...
.method public isDeltaCRLIndicatorEnabled()Z
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->d:Z
...
.method public isIssuingDistributionPointEnabled()Z
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->h:Z
...
.method public match(Ljava/lang/Object;)Z
    ...
    iget-object v2, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->f:Ljava/math/BigInteger;
    ...
    iget-object v2, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->g:[B
...
.method public setAttrCertificateChecking(Lorg/bouncycastle/x509/X509AttributeCertificate;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->i:Lorg/bouncycastle/x509/X509AttributeCertificate;
...
.method public setDeltaCRLIndicatorEnabled(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->d:Z
...
.method public setIssuingDistributionPoint([B)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->g:[B
...
.method public setIssuingDistributionPointEnabled(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->h:Z
...
.method public setMaxBaseCRLNumber(Ljava/math/BigInteger;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/X509CRLStoreSelector;->f:Ljava/math/BigInteger;
