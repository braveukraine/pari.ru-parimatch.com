...
.field public e:Lorg/bouncycastle/util/Selector;
...
.method public constructor <init>(Ljava/util/Set;)V
    ...
    iput p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->l:I

    iput-boolean p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->m:Z
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->g:Ljava/util/List;
    ...
    iput-object p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->i:Ljava/util/Set;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->j:Ljava/util/Set;

    new-instance p1, Ljava/util/HashSet;

    invoke-direct {p1}, Ljava/util/HashSet;-><init>()V

    iput-object p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->k:Ljava/util/Set;
...
.method public addAdditionalStore(Lorg/bouncycastle/util/Store;)V
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->g:Ljava/util/List;
...
.method public getAttrCertCheckers()Ljava/util/Set;
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->k:Ljava/util/Set;
...
.method public getNecessaryACAttributes()Ljava/util/Set;
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->i:Ljava/util/Set;
...
.method public getProhibitedACAttributes()Ljava/util/Set;
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->j:Ljava/util/Set;
...
.method public getStores()Ljava/util/List;
    ...
    iget-object v1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->d:Ljava/util/List;
...
.method public getTargetConstraints()Lorg/bouncycastle/util/Selector;
    ...
    iget-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->e:Lorg/bouncycastle/util/Selector;
...
.method public getValidityModel()I
    ...
    iget v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->l:I
...
.method public isAdditionalLocationsEnabled()Z
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->f:Z
...
.method public isUseDeltasEnabled()Z
    ...
    iget-boolean v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->m:Z
...
.method public setAdditionalLocationsEnabled(Z)V
    ...
    iput-boolean p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->f:Z
...
.method public setAttrCertCheckers(Ljava/util/Set;)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->k:Ljava/util/Set;
...
.method public setNecessaryACAttributes(Ljava/util/Set;)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->i:Ljava/util/Set;
...
.method public setParams(Ljava/security/cert/PKIXParameters;)V
    ...
    iget v0, p1, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->l:I

    iput v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->l:I

    iget-boolean v0, p1, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->m:Z

    iput-boolean v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->m:Z

    iget-boolean v0, p1, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->f:Z

    iput-boolean v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->f:Z

    iget-object v0, p1, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->e:Lorg/bouncycastle/util/Selector;
    ...
    :goto_0
    iput-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->e:Lorg/bouncycastle/util/Selector;
    ...
    iget-object v1, p1, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->g:Ljava/util/List;

    invoke-direct {v0, v1}, Ljava/util/ArrayList;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->g:Ljava/util/List;
    ...
    iget-object v1, p1, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->j:Ljava/util/Set;

    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->j:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    iget-object v1, p1, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->i:Ljava/util/Set;

    invoke-direct {v0, v1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->i:Ljava/util/Set;

    new-instance v0, Ljava/util/HashSet;

    iget-object p1, p1, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->k:Ljava/util/Set;

    invoke-direct {v0, p1}, Ljava/util/HashSet;-><init>(Ljava/util/Collection;)V

    iput-object v0, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->k:Ljava/util/Set;
...
.method public setProhibitedACAttributes(Ljava/util/Set;)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->j:Ljava/util/Set;
...
.method public setTargetCertConstraints(Ljava/security/cert/CertSelector;)V
    ...
    :goto_0
    iput-object p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->e:Lorg/bouncycastle/util/Selector;
...
.method public setTrustedACIssuers(Ljava/util/Set;)V
    ...
    iget-object p1, p0, Lorg/bouncycastle/x509/ExtendedPKIXParameters;->h:Ljava/util/Set;
