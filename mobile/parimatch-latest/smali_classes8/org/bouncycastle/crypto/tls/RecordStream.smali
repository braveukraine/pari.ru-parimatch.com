...
# instance fields
.field public a:Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;

.field public b:Ljava/io/InputStream;

.field public c:Ljava/io/OutputStream;

.field public hash1:Lorg/bouncycastle/crypto/tls/CombinedHash;

.field public hash2:Lorg/bouncycastle/crypto/tls/CombinedHash;

.field public readSuite:Lorg/bouncycastle/crypto/tls/TlsCipherSuite;

.field public writeSuite:Lorg/bouncycastle/crypto/tls/TlsCipherSuite;
...
.method public constructor <init>(Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;Ljava/io/InputStream;Ljava/io/OutputStream;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->a:Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;
...
.method public close()V
    ...
    :goto_0
    :try_start_1
    iget-object v1, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->c:Ljava/io/OutputStream;
...
.method public decodeAndVerify(SLjava/io/InputStream;I)[B
    ...
    iget-object v5, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->a:Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;
...
.method public flush()V
    ...
    iget-object v0, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->c:Ljava/io/OutputStream;
...
.method public readData()V
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->a:Lorg/bouncycastle/crypto/tls/TlsProtocolHandler;
    ...
    iget-object v2, p0, Lorg/bouncycastle/crypto/tls/RecordStream;->b:Ljava/io/InputStream;
...
.method public writeMessage(S[BII)V
    ...
    invoke-static {p1, p3, v1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint8(S[BI)V

    const/4 v2, 0x2

    invoke-static {v1, p3, v2}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint8(S[BI)V

    array-length v1, p2

    invoke-static {v1, p3, p1}, Lorg/bouncycastle/crypto/tls/TlsUtils;->writeUint16(I[BI)V
