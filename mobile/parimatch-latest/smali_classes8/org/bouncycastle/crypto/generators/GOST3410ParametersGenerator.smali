...
.method public final b(JJ[Ljava/math/BigInteger;I)J
    ...
    sget-object v9, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->e:Ljava/math/BigInteger;
...
.method public generateParameters()Lorg/bouncycastle/crypto/params/GOST3410Parameters;
    ...
    iget v1, v7, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->b:I
    ...
    iget-object v1, v7, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->c:Ljava/security/SecureRandom;

    invoke-virtual {v1}, Ljava/security/SecureRandom;->nextInt()I

    move-result v1

    iget-object v4, v7, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->c:Ljava/security/SecureRandom;

    invoke-virtual {v4}, Ljava/security/SecureRandom;->nextInt()I

    move-result v4

    iget v5, v7, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->a:I
    ...
    invoke-virtual {v7, v2, v14, v0, v6}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->a(II[Ljava/math/BigInteger;I)I

    move-result v2

    aget-object v6, v0, v13

    invoke-virtual {v7, v2, v14, v0, v3}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->a(II[Ljava/math/BigInteger;I)I
    ...
    :cond_7
    :goto_6
    iget-object v9, v7, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->c:Ljava/security/SecureRandom;
    ...
    :cond_8
    :goto_7
    iget-object v2, v7, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->c:Ljava/security/SecureRandom;
    ...
    :cond_a
    invoke-virtual {v7, v1, v4, v8, v3}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->a(II[Ljava/math/BigInteger;I)I
    ...
    invoke-virtual {v7, v0, v2}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v5, v0, v2, v3, v6}, Lorg/bouncycastle/crypto/params/GOST3410Parameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;)V
    ...
    iget v1, v7, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->a:I
    ...
    invoke-virtual/range {v0 .. v6}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->b(JJ[Ljava/math/BigInteger;I)J
    ...
    invoke-virtual {v7, v0, v1}, Lorg/bouncycastle/crypto/generators/GOST3410ParametersGenerator;->c(Ljava/math/BigInteger;Ljava/math/BigInteger;)Ljava/math/BigInteger;
    ...
    invoke-direct {v4, v11, v12, v5, v6}, Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;-><init>(JJ)V

    invoke-direct {v3, v0, v1, v2, v4}, Lorg/bouncycastle/crypto/params/GOST3410Parameters;-><init>(Ljava/math/BigInteger;Ljava/math/BigInteger;Ljava/math/BigInteger;Lorg/bouncycastle/crypto/params/GOST3410ValidationParameters;)V
