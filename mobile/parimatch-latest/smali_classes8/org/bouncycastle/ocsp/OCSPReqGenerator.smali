...
.annotation system Ldalvik/annotation/MemberClasses;
    value = {
        Lorg/bouncycastle/ocsp/OCSPReqGenerator$a;
    }
.end annotation
...
.field public b:Lorg/bouncycastle/asn1/x509/GeneralName;

.field public c:Lorg/bouncycastle/asn1/x509/X509Extensions;
...
# virtual methods
.method public final a(Lorg/bouncycastle/asn1/DERObjectIdentifier;Ljava/security/PrivateKey;[Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/security/SecureRandom;)Lorg/bouncycastle/ocsp/OCSPReq;
    .locals 5
    ...
    iget-object v0, p0, Lorg/bouncycastle/ocsp/OCSPReqGenerator;->a:Ljava/util/List;
    ...
    check-cast v2, Lorg/bouncycastle/ocsp/OCSPReqGenerator$a;

    .line 1
    new-instance v3, Lorg/bouncycastle/asn1/ocsp/Request;

    iget-object v4, v2, Lorg/bouncycastle/ocsp/OCSPReqGenerator$a;->a:Lorg/bouncycastle/ocsp/CertificateID;

    invoke-virtual {v4}, Lorg/bouncycastle/ocsp/CertificateID;->toASN1Object()Lorg/bouncycastle/asn1/ocsp/CertID;

    move-result-object v4

    iget-object v2, v2, Lorg/bouncycastle/ocsp/OCSPReqGenerator$a;->b:Lorg/bouncycastle/asn1/x509/X509Extensions;

    invoke-direct {v3, v4, v2}, Lorg/bouncycastle/asn1/ocsp/Request;-><init>(Lorg/bouncycastle/asn1/ocsp/CertID;Lorg/bouncycastle/asn1/x509/X509Extensions;)V
    ...
    iget-object v2, p0, Lorg/bouncycastle/ocsp/OCSPReqGenerator;->b:Lorg/bouncycastle/asn1/x509/GeneralName;

    new-instance v3, Lorg/bouncycastle/asn1/DERSequence;

    invoke-direct {v3, v1}, Lorg/bouncycastle/asn1/DERSequence;-><init>(Lorg/bouncycastle/asn1/DEREncodableVector;)V

    iget-object v1, p0, Lorg/bouncycastle/ocsp/OCSPReqGenerator;->c:Lorg/bouncycastle/asn1/x509/X509Extensions;
    ...
    iget-object v1, p0, Lorg/bouncycastle/ocsp/OCSPReqGenerator;->b:Lorg/bouncycastle/asn1/x509/GeneralName;
    ...
    invoke-static {v1, p4}, Lorg/bouncycastle/ocsp/a;->a(Ljava/lang/String;Ljava/lang/String;)Ljava/security/Signature;
...
.method public addRequest(Lorg/bouncycastle/ocsp/CertificateID;)V
    ...
    new-instance v1, Lorg/bouncycastle/ocsp/OCSPReqGenerator$a;

    const/4 v2, 0x0

    invoke-direct {v1, p0, p1, v2}, Lorg/bouncycastle/ocsp/OCSPReqGenerator$a;-><init>(Lorg/bouncycastle/ocsp/OCSPReqGenerator;Lorg/bouncycastle/ocsp/CertificateID;Lorg/bouncycastle/asn1/x509/X509Extensions;)V
...
.method public addRequest(Lorg/bouncycastle/ocsp/CertificateID;Lorg/bouncycastle/asn1/x509/X509Extensions;)V
    ...
    invoke-direct {v1, p0, p1, p2}, Lorg/bouncycastle/ocsp/OCSPReqGenerator$a;-><init>(Lorg/bouncycastle/ocsp/OCSPReqGenerator;Lorg/bouncycastle/ocsp/CertificateID;Lorg/bouncycastle/asn1/x509/X509Extensions;)V
...
.method public generate()Lorg/bouncycastle/ocsp/OCSPReq;
    ...
    :try_start_0
    invoke-virtual/range {v0 .. v5}, Lorg/bouncycastle/ocsp/OCSPReqGenerator;->a(Lorg/bouncycastle/asn1/DERObjectIdentifier;Ljava/security/PrivateKey;[Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/security/SecureRandom;)Lorg/bouncycastle/ocsp/OCSPReq;
...
.method public generate(Ljava/lang/String;Ljava/security/PrivateKey;[Ljava/security/cert/X509Certificate;Ljava/lang/String;Ljava/security/SecureRandom;)Lorg/bouncycastle/ocsp/OCSPReq;
    ...
    :try_start_0
    invoke-static {p1}, Lorg/bouncycastle/ocsp/a;->c(Ljava/lang/String;)Lorg/bouncycastle/asn1/DERObjectIdentifier;
    ...
    const-string p3, "unknown signing algorithm specified: "
...
.method public setRequestExtensions(Lorg/bouncycastle/asn1/x509/X509Extensions;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/ocsp/OCSPReqGenerator;->c:Lorg/bouncycastle/asn1/x509/X509Extensions;
...
.method public setRequestorName(Ljavax/security/auth/x500/X500Principal;)V
    ...
    const-string v1, "cannot encode principal: "
...
.method public setRequestorName(Lorg/bouncycastle/asn1/x509/GeneralName;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/ocsp/OCSPReqGenerator;->b:Lorg/bouncycastle/asn1/x509/GeneralName;
