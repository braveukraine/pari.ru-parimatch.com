...
.field public m:Ljava/security/Signature;

.field public transient n:Ljava/security/PrivateKey;
...
.method public constructor <init>(Ljava/security/PrivateKey;[Ljava/security/cert/Certificate;[Ljava/security/cert/CRL;Ljava/lang/String;Ljava/lang/String;)V
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->n:Ljava/security/PrivateKey;
    ...
    const-string p4, "1.2.840.113549.2.5"
    ...
    const-string p4, "1.2.840.113549.2.2"

    :goto_0
    iput-object p4, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->k:Ljava/lang/String;
    ...
    :goto_1
    iput-object v1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->k:Ljava/lang/String;

    :goto_2
    const/4 p4, 0x1

    iput p4, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->e:I

    iput p4, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->d:I

    new-instance p4, Ljava/util/ArrayList;

    invoke-direct {p4}, Ljava/util/ArrayList;-><init>()V

    iput-object p4, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->g:Ljava/util/Collection;

    new-instance p4, Ljava/util/ArrayList;

    invoke-direct {p4}, Ljava/util/ArrayList;-><init>()V

    iput-object p4, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->h:Ljava/util/Collection;

    new-instance p4, Ljava/util/HashSet;

    invoke-direct {p4}, Ljava/util/HashSet;-><init>()V

    iput-object p4, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->f:Ljava/util/Set;

    iget-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->k:Ljava/lang/String;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->i:Ljava/security/cert/X509Certificate;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->g:Ljava/util/Collection;
    ...
    iget-object p2, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->h:Ljava/util/Collection;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->l:Ljava/lang/String;
    ...
    :cond_5
    iget-object p2, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->l:Ljava/lang/String;
    ...
    iput-object p2, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->m:Ljava/security/Signature;
    ...
    iget-object p3, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->l:Ljava/lang/String;
    ...
    const-string p2, "Unknown Hash Algorithm "
...
.method public constructor <init>([BLjava/lang/String;)V
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->g:Ljava/util/Collection;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->h:Ljava/util/Collection;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->h:Ljava/util/Collection;
    ...
    iput v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->d:I

    new-instance v0, Ljava/util/HashSet;

    invoke-direct {v0}, Ljava/util/HashSet;-><init>()V

    iput-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->f:Ljava/util/Set;
    ...
    iget-object v2, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->f:Ljava/util/Set;
    ...
    iput v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->e:I
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->g:Ljava/util/Collection;
    ...
    invoke-virtual {v2, v4}, Lorg/bouncycastle/asn1/x509/X509Name;->equals(Ljava/lang/Object;)Z

    move-result v4

    if-eqz v4, :cond_3

    iput-object v3, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->i:Ljava/security/cert/X509Certificate;

    :cond_4
    iget-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->i:Ljava/security/cert/X509Certificate;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->k:Ljava/lang/String;
    ...
    iput-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->j:[B
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->l:Ljava/lang/String;
    ...
    iput-object p1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->m:Ljava/security/Signature;

    iget-object p2, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->i:Ljava/security/cert/X509Certificate;
    ...
    const-string p2, "Can\'t find signing certificate with serial "
    ...
    const-string v0, "Not a valid PKCS#7 signed-data object - wrong header "
...
# virtual methods
.method public final a([B)Lorg/bouncycastle/asn1/DERObject;
    .locals 2
    ...
    const-string v1, "IOException reading from ByteArray: "
...
.method public getCRLs()Ljava/util/Collection;
    ...
    iget-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->h:Ljava/util/Collection;
...
.method public getDigestAlgorithm()Ljava/lang/String;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->l:Ljava/lang/String;
    ...
    :cond_0
    iget-object v2, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->k:Ljava/lang/String;
    ...
    :cond_2
    :goto_0
    iget-object v2, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->l:Ljava/lang/String;
    ...
    invoke-static {v0, v2, v1}, La/n;->a(Ljava/lang/String;Ljava/lang/String;Ljava/lang/String;)Ljava/lang/String;
...
.method public getEncoded()[B
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->m:Ljava/security/Signature;
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->f:Ljava/util/Set;
    ...
    iget-object v3, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->g:Ljava/util/Collection;
    ...
    invoke-virtual {v2, v4}, Lorg/bouncycastle/asn1/DEREncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    iget v5, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->e:I
    ...
    iget-object v6, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->i:Ljava/security/cert/X509Certificate;

    invoke-virtual {v6}, Ljava/security/cert/X509Certificate;->getTBSCertificate()[B

    move-result-object v6

    invoke-virtual {p0, v6}, Lorg/bouncycastle/jce/PKCS7SignedData;->a([B)Lorg/bouncycastle/asn1/DERObject;
    ...
    iget-object v7, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->i:Ljava/security/cert/X509Certificate;
    ...
    iget-object v6, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->k:Ljava/lang/String;
    ...
    iget-object v6, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->l:Ljava/lang/String;
    ...
    iget-object v5, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->j:[B
    ...
    iget v6, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->d:I
    ...
    invoke-virtual {v4, v1}, Lorg/bouncycastle/asn1/DEREncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V

    invoke-virtual {v4, v0}, Lorg/bouncycastle/asn1/DEREncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V
    ...
    iget-object v3, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->h:Ljava/util/Collection;
    ...
    invoke-virtual {v0, v5}, Lorg/bouncycastle/asn1/DEREncodableVector;->add(Lorg/bouncycastle/asn1/DEREncodable;)V
...
.method public getSigningInfoVersion()I
    ...
    iget v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->e:I
...
.method public getVersion()I
    ...
    iget v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->d:I
...
.method public reset()V
    ...
    :try_start_0
    iget-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->n:Ljava/security/PrivateKey;

    if-nez v0, :cond_0

    iget-object v0, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->m:Ljava/security/Signature;

    iget-object v1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->i:Ljava/security/cert/X509Certificate;
    ...
    :cond_0
    iget-object v1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->m:Ljava/security/Signature;
...
.method public verify()Z
    ...
    iget-object v1, p0, Lorg/bouncycastle/jce/PKCS7SignedData;->j:[B
