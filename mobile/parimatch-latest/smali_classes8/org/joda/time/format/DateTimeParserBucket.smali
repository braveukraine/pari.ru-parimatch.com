...
.method public static synthetic a(Lorg/joda/time/format/DateTimeParserBucket;)Lorg/joda/time/DateTimeZone;
    .locals 0
...
.method public static synthetic b(Lorg/joda/time/format/DateTimeParserBucket;Lorg/joda/time/DateTimeZone;)Lorg/joda/time/DateTimeZone;
    .locals 0
...
.method public static synthetic c(Lorg/joda/time/format/DateTimeParserBucket;)Ljava/lang/Integer;
    .locals 0
...
.method public static synthetic d(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/Integer;)Ljava/lang/Integer;
    .locals 0
...
.method public static synthetic e(Lorg/joda/time/format/DateTimeParserBucket;)[Lorg/joda/time/format/DateTimeParserBucket$a;
    .locals 0
...
.method public static synthetic f(Lorg/joda/time/format/DateTimeParserBucket;[Lorg/joda/time/format/DateTimeParserBucket$a;)[Lorg/joda/time/format/DateTimeParserBucket$a;
    .locals 0
...
.method public static synthetic g(Lorg/joda/time/format/DateTimeParserBucket;)I
    .locals 0
...
.method public static synthetic h(Lorg/joda/time/format/DateTimeParserBucket;I)I
    .locals 0
...
.method public static synthetic i(Lorg/joda/time/format/DateTimeParserBucket;Z)Z
    .locals 0
...
.method public static j(Lorg/joda/time/DurationField;Lorg/joda/time/DurationField;)I
    .locals 1
...
.method public computeMillis(ZLjava/lang/CharSequence;)J
    ...
    iget-object v3, v3, Lorg/joda/time/format/DateTimeParserBucket$a;->d:Lorg/joda/time/DateTimeField;
    ...
    .line 13
    invoke-static {v3, v2}, Lorg/joda/time/format/DateTimeParserBucket;->j(Lorg/joda/time/DurationField;Lorg/joda/time/DurationField;)I

    move-result v2

    if-ltz v2, :cond_1

    invoke-static {v3, v4}, Lorg/joda/time/format/DateTimeParserBucket;->j(Lorg/joda/time/DurationField;Lorg/joda/time/DurationField;)I
    ...
    invoke-virtual {v6, v2, v3, p1}, Lorg/joda/time/format/DateTimeParserBucket$a;->b(JZ)J
    ...
    iget-object v4, v4, Lorg/joda/time/format/DateTimeParserBucket$a;->d:Lorg/joda/time/DateTimeField;
    ...
    :goto_2
    invoke-virtual {v4, v2, v3, v6}, Lorg/joda/time/format/DateTimeParserBucket$a;->b(JZ)J
...
.method public k(Lgi/b;Ljava/lang/CharSequence;)J
    .locals 1

    const/4 v0, 0x0

    .line 1
    invoke-interface {p1, p0, p2, v0}, Lgi/b;->parseInto(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/CharSequence;I)I
...
.method public parseMillis(Lorg/joda/time/format/DateTimeParser;Ljava/lang/CharSequence;)J
    ...
    invoke-virtual {p0, p1, p2}, Lorg/joda/time/format/DateTimeParserBucket;->k(Lgi/b;Ljava/lang/CharSequence;)J
...
.method public restoreState(Ljava/lang/Object;)Z
    ...
    .line 3
    iget-object v2, v0, Lorg/joda/time/format/DateTimeParserBucket$b;->e:Lorg/joda/time/format/DateTimeParserBucket;
    ...
    .line 4
    :cond_0
    iget-object v2, v0, Lorg/joda/time/format/DateTimeParserBucket$b;->a:Lorg/joda/time/DateTimeZone;

    invoke-static {p0, v2}, Lorg/joda/time/format/DateTimeParserBucket;->b(Lorg/joda/time/format/DateTimeParserBucket;Lorg/joda/time/DateTimeZone;)Lorg/joda/time/DateTimeZone;

    .line 5
    iget-object v2, v0, Lorg/joda/time/format/DateTimeParserBucket$b;->b:Ljava/lang/Integer;

    invoke-static {p0, v2}, Lorg/joda/time/format/DateTimeParserBucket;->d(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/Integer;)Ljava/lang/Integer;

    .line 6
    iget-object v2, v0, Lorg/joda/time/format/DateTimeParserBucket$b;->c:[Lorg/joda/time/format/DateTimeParserBucket$a;

    invoke-static {p0, v2}, Lorg/joda/time/format/DateTimeParserBucket;->f(Lorg/joda/time/format/DateTimeParserBucket;[Lorg/joda/time/format/DateTimeParserBucket$a;)[Lorg/joda/time/format/DateTimeParserBucket$a;

    .line 7
    iget v2, v0, Lorg/joda/time/format/DateTimeParserBucket$b;->d:I

    invoke-static {p0}, Lorg/joda/time/format/DateTimeParserBucket;->g(Lorg/joda/time/format/DateTimeParserBucket;)I
    ...
    .line 8
    invoke-static {p0, v3}, Lorg/joda/time/format/DateTimeParserBucket;->i(Lorg/joda/time/format/DateTimeParserBucket;Z)Z

    .line 9
    :cond_1
    iget v0, v0, Lorg/joda/time/format/DateTimeParserBucket$b;->d:I

    invoke-static {p0, v0}, Lorg/joda/time/format/DateTimeParserBucket;->h(Lorg/joda/time/format/DateTimeParserBucket;I)I
...
.method public saveField(Lorg/joda/time/DateTimeField;I)V
    ...
    .line 2
    iput-object p1, v0, Lorg/joda/time/format/DateTimeParserBucket$a;->d:Lorg/joda/time/DateTimeField;

    .line 3
    iput p2, v0, Lorg/joda/time/format/DateTimeParserBucket$a;->e:I

    const/4 p1, 0x0

    .line 4
    iput-object p1, v0, Lorg/joda/time/format/DateTimeParserBucket$a;->f:Ljava/lang/String;

    .line 5
    iput-object p1, v0, Lorg/joda/time/format/DateTimeParserBucket$a;->g:Ljava/util/Locale;
...
.method public saveField(Lorg/joda/time/DateTimeFieldType;Ljava/lang/String;Ljava/util/Locale;)V
    ...
    .line 13
    iput p1, v0, Lorg/joda/time/format/DateTimeParserBucket$a;->e:I

    .line 14
    iput-object p2, v0, Lorg/joda/time/format/DateTimeParserBucket$a;->f:Ljava/lang/String;

    .line 15
    iput-object p3, v0, Lorg/joda/time/format/DateTimeParserBucket$a;->g:Ljava/util/Locale;
