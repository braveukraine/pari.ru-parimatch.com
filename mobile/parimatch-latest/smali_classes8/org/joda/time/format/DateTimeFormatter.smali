...
.field private final iParser:Lgi/b;

.field private final iPivotYear:Ljava/lang/Integer;

.field private final iPrinter:Lorg/joda/time/format/b;
...
.method public constructor <init>(Lorg/joda/time/format/DateTimePrinter;Lorg/joda/time/format/DateTimeParser;)V
    ...
    invoke-direct {p0, p1, p2}, Lorg/joda/time/format/DateTimeFormatter;-><init>(Lorg/joda/time/format/b;Lgi/b;)V

    return-void
.end method

.method public constructor <init>(Lorg/joda/time/format/b;Lgi/b;)V
    .locals 0
    ...
    .line 3
    iput-object p1, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/b;

    .line 4
    iput-object p2, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lgi/b;
...
.method private constructor <init>(Lorg/joda/time/format/b;Lgi/b;Ljava/util/Locale;ZLorg/joda/time/Chronology;Lorg/joda/time/DateTimeZone;Ljava/lang/Integer;I)V
    .locals 0
...
.method private printTo(Ljava/lang/Appendable;JLorg/joda/time/Chronology;)V
    ...
    .line 17
    invoke-direct/range {p0 .. p0}, Lorg/joda/time/format/DateTimeFormatter;->requirePrinter()Lorg/joda/time/format/b;
...
.method private requireParser()Lgi/b;
    .locals 2

    .line 1
    iget-object v0, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lgi/b;
...
.method private requirePrinter()Lorg/joda/time/format/b;
    .locals 2

    .line 1
    iget-object v0, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/b;
...
.method public b()Lorg/joda/time/format/b;
    .locals 1
...
.method public parseDateTime(Ljava/lang/String;)Lorg/joda/time/DateTime;
    ...
    .line 1
    invoke-direct {p0}, Lorg/joda/time/format/DateTimeFormatter;->requireParser()Lgi/b;
    ...
    .line 4
    invoke-interface {v0, v9, p1, v2}, Lgi/b;->parseInto(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/CharSequence;I)I
...
.method public parseInto(Lorg/joda/time/ReadWritableInstant;Ljava/lang/String;I)I
    ...
    .line 8
    invoke-interface {v0, v2, p2, p3}, Lgi/b;->parseInto(Lorg/joda/time/format/DateTimeParserBucket;Ljava/lang/CharSequence;I)I
...
.method public parseMillis(Ljava/lang/String;)J
    ...
    .line 4
    invoke-virtual {v1, v0, p1}, Lorg/joda/time/format/DateTimeParserBucket;->k(Lgi/b;Ljava/lang/CharSequence;)J
...
.method public print(J)Ljava/lang/String;
    ...
    invoke-direct {p0}, Lorg/joda/time/format/DateTimeFormatter;->requirePrinter()Lorg/joda/time/format/b;

    move-result-object v1

    invoke-interface {v1}, Lorg/joda/time/format/b;->estimatePrintedLength()I
...
.method public printTo(Ljava/lang/Appendable;Lorg/joda/time/ReadablePartial;)V
    ...
    invoke-interface {v0, p1, p2, v1}, Lorg/joda/time/format/b;->printTo(Ljava/lang/Appendable;Lorg/joda/time/ReadablePartial;Ljava/util/Locale;)V
...
.method public withChronology(Lorg/joda/time/Chronology;)Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget-object v2, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/b;

    iget-object v3, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lgi/b;
    ...
    invoke-direct/range {v1 .. v9}, Lorg/joda/time/format/DateTimeFormatter;-><init>(Lorg/joda/time/format/b;Lgi/b;Ljava/util/Locale;ZLorg/joda/time/Chronology;Lorg/joda/time/DateTimeZone;Ljava/lang/Integer;I)V
...
.method public withDefaultYear(I)Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget-object v1, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/b;

    iget-object v2, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lgi/b;
    ...
    invoke-direct/range {v0 .. v8}, Lorg/joda/time/format/DateTimeFormatter;-><init>(Lorg/joda/time/format/b;Lgi/b;Ljava/util/Locale;ZLorg/joda/time/Chronology;Lorg/joda/time/DateTimeZone;Ljava/lang/Integer;I)V
...
.method public withOffsetParsed()Lorg/joda/time/format/DateTimeFormatter;
    ...
    iget-object v3, p0, Lorg/joda/time/format/DateTimeFormatter;->iPrinter:Lorg/joda/time/format/b;

    iget-object v4, p0, Lorg/joda/time/format/DateTimeFormatter;->iParser:Lgi/b;
    ...
    invoke-direct/range {v2 .. v10}, Lorg/joda/time/format/DateTimeFormatter;-><init>(Lorg/joda/time/format/b;Lgi/b;Ljava/util/Locale;ZLorg/joda/time/Chronology;Lorg/joda/time/DateTimeZone;Ljava/lang/Integer;I)V
