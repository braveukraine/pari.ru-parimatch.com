...
.method public static of(Ljava/util/Locale;)Lorg/threeten/bp/format/DecimalStyle;
    ...
    .line 7
    sget-object v1, Lorg/threeten/bp/format/DecimalStyle;->STANDARD:Lorg/threeten/bp/format/DecimalStyle;

    goto :goto_0

    .line 8
    :cond_0
    new-instance v4, Lorg/threeten/bp/format/DecimalStyle;

    const/16 v5, 0x2b

    invoke-direct {v4, v2, v5, v3, v1}, Lorg/threeten/bp/format/DecimalStyle;-><init>(CCCC)V
    ...
    invoke-virtual {v2, p0, v1}, Lj$/util/concurrent/ConcurrentHashMap;->putIfAbsent(Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
