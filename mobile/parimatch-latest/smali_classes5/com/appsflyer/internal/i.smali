...
.field private static AppsFlyer2dXConversionCallback:Lcom/appsflyer/internal/i;
...
.method public static constructor <clinit>()V
    ...
    sput v1, Lcom/appsflyer/internal/i;->AFKeystoreWrapper:I
...
.method private AFInAppEventParameterName(Landroid/content/Intent;Landroid/content/Context;Ljava/util/Map;)Z
    ...
    .line 14
    :goto_0
    sget-object v3, Lcom/appsflyer/internal/i;->valueOf:Landroid/content/Intent;
    ...
    .line 23
    :cond_6
    invoke-direct {p0, v7, v6}, Lcom/appsflyer/internal/i;->values(Ljava/lang/Object;Ljava/util/Iterator;)Landroid/net/Uri;
    ...
    .line 25
    invoke-static {p3}, Lcom/appsflyer/internal/ah;->AFKeystoreWrapper(Ljava/util/Map;)Ljava/util/Map;
    ...
    .line 28
    invoke-virtual {p0, p2, p3, v2}, Lcom/appsflyer/internal/i;->AFInAppEventParameterName(Landroid/content/Context;Ljava/util/Map;Landroid/net/Uri;)V
    ...
    .line 32
    sget-object p1, Lcom/appsflyer/internal/i;->valueOf:Landroid/content/Intent;
    ...
    .line 34
    invoke-virtual {p0, p2, p3, v0}, Lcom/appsflyer/internal/i;->AFInAppEventParameterName(Landroid/content/Context;Ljava/util/Map;Landroid/net/Uri;)V
    ...
    .line 40
    invoke-virtual {p0, p2, p3, v1}, Lcom/appsflyer/internal/i;->AFInAppEventParameterName(Landroid/content/Context;Ljava/util/Map;Landroid/net/Uri;)V
...
.method public static synthetic AFInAppEventType(Ljava/lang/String;)Z
    ...
    .line 1
    invoke-static {p0}, Lcom/appsflyer/internal/i;->valueOf(Ljava/lang/String;)Z
...
.method public static AFKeystoreWrapper()Lcom/appsflyer/internal/i;
    .locals 1

    .line 1
    sget-object v0, Lcom/appsflyer/internal/i;->AppsFlyer2dXConversionCallback:Lcom/appsflyer/internal/i;
    ...
    sput-object v0, Lcom/appsflyer/internal/i;->AppsFlyer2dXConversionCallback:Lcom/appsflyer/internal/i;
...
.method private static valueOf(Ljava/lang/String;)Z
    ...
    .line 1
    sget-object v0, Lcom/appsflyer/internal/i;->AFInAppEventType:[Ljava/lang/String;
    ...
    sget-object v2, Lcom/appsflyer/internal/i;->AFInAppEventType:[Ljava/lang/String;
...
.method public static values(Landroid/content/Intent;)Landroid/net/Uri;
    .locals 2
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
...
.method public final AFInAppEventParameterName(Landroid/content/Context;Ljava/util/Map;Landroid/net/Uri;)V
    ...
    invoke-static {v0}, Lcom/appsflyer/internal/i;->valueOf(Ljava/lang/String;)Z
    ...
    .line 6
    iget-object v1, v0, Lcom/appsflyer/internal/m;->AFKeystoreWrapper:Ljava/util/concurrent/ScheduledExecutorService;

    if-nez v1, :cond_1

    .line 7
    iget-object v1, v0, Lcom/appsflyer/internal/m;->valueOf:Ljava/util/concurrent/ThreadFactory;

    invoke-static {v1}, Ljava/util/concurrent/Executors;->newSingleThreadScheduledExecutor(Ljava/util/concurrent/ThreadFactory;)Ljava/util/concurrent/ScheduledExecutorService;

    move-result-object v1

    iput-object v1, v0, Lcom/appsflyer/internal/m;->AFKeystoreWrapper:Ljava/util/concurrent/ScheduledExecutorService;

    .line 8
    :cond_1
    iget-object v0, v0, Lcom/appsflyer/internal/m;->AFKeystoreWrapper:Ljava/util/concurrent/ScheduledExecutorService;
    ...
    invoke-virtual {v0, p1, p2, p3}, Lcom/appsflyer/internal/ah;->valueOf(Landroid/content/Context;Ljava/util/Map;Landroid/net/Uri;)V

    :goto_0
    const/4 p1, 0x0

    .line 11
    sput-object p1, Lcom/appsflyer/internal/i;->valueOf:Landroid/content/Intent;

    return-void
.end method

.method public final AFKeystoreWrapper(Ljava/util/Map;Lcom/appsflyer/internal/cf;Landroid/content/Intent;Lcom/appsflyer/internal/bo;Landroid/content/Context;)V
    .locals 3
    .annotation system Ldalvik/annotation/Signature;
        value = {
            "(",
    ...
    .line 4
    invoke-static {p5}, Lcom/appsflyer/internal/ah;->valueOf(Landroid/content/Context;)Landroid/content/SharedPreferences;

    move-result-object v0

    .line 5
    invoke-direct {p0, p3, p5, p1}, Lcom/appsflyer/internal/i;->AFInAppEventParameterName(Landroid/content/Intent;Landroid/content/Context;Ljava/util/Map;)Z
    ...
    iget-object p1, p0, Lcom/appsflyer/internal/i;->AFInAppEventParameterName:Lcom/appsflyer/deeplink/DeepLinkListener;
    ...
    invoke-virtual {p1, v0, v1}, Lcom/appsflyer/internal/ah;->valueOf(Landroid/content/SharedPreferences;Z)I
    ...
    invoke-direct {p1, p5, p2}, Lcom/appsflyer/internal/ao;-><init>(Landroid/content/Context;Lcom/appsflyer/internal/cf;)V
    ...
    new-instance p5, Lcom/appsflyer/internal/ao$4;

    invoke-direct {p5, p1}, Lcom/appsflyer/internal/ao$4;-><init>(Lcom/appsflyer/internal/ao;)V
    ...
    .line 12
    :try_start_0
    sget-wide v0, Lcom/appsflyer/internal/ao;->onAttributionFailureNative:J
    ...
    .line 13
    iget-object v0, p1, Lcom/appsflyer/internal/ao;->onInstallConversionFailureNative:Lcom/appsflyer/internal/cf;

    sget-wide v1, Lcom/appsflyer/internal/ao;->onAttributionFailureNative:J

    invoke-virtual {v0, p2, v1, v2}, Lcom/appsflyer/internal/cf;->values(Lcom/appsflyer/deeplink/DeepLinkResult;J)V

    .line 14
    invoke-static {p2}, Lcom/appsflyer/internal/aq;->valueOf(Lcom/appsflyer/deeplink/DeepLinkResult;)V
    :try_end_0
    ...
    iget v0, p1, Lcom/appsflyer/internal/ao;->onResponseErrorNative:I
    ...
    .line 17
    iget-object p1, p1, Lcom/appsflyer/internal/ao;->onInstallConversionFailureNative:Lcom/appsflyer/internal/cf;

    sget-wide v0, Lcom/appsflyer/internal/ao;->onAttributionFailureNative:J

    invoke-virtual {p1, p2, v0, v1}, Lcom/appsflyer/internal/cf;->values(Lcom/appsflyer/deeplink/DeepLinkResult;J)V
    ...
    .line 19
    invoke-static {v0, p2}, Lcom/appsflyer/AFLogger;->valueOf(Ljava/lang/String;Ljava/lang/Throwable;)V
    ...
    invoke-virtual {p1, v0, v1, v2}, Lcom/appsflyer/internal/cf;->values(Lcom/appsflyer/deeplink/DeepLinkResult;J)V

    .line 25
    invoke-static {v0}, Lcom/appsflyer/internal/aq;->valueOf(Lcom/appsflyer/deeplink/DeepLinkResult;)V
    ...
    .line 26
    invoke-interface {p4, p3, p1}, Lcom/appsflyer/internal/bo;->values(Ljava/lang/String;Z)V
