...
.method public constructor <init>()V
    ...
    iput-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->b:Lo4/c;
...
.method public final a(Ljava/lang/Integer;Landroid/graphics/Bitmap;)V
    ...
    .line 2
    invoke-virtual {p0, v0}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->c(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
...
.method public get(IILandroid/graphics/Bitmap$Config;)Landroid/graphics/Bitmap;
    ...
    .line 3
    invoke-virtual {v1}, Lo4/b;->b()Lo4/e;

    move-result-object v1

    check-cast v1, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$b;

    .line 4
    iput v0, v1, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$b;->b:I

    .line 5
    iput-object p3, v1, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$b;->c:Landroid/graphics/Bitmap$Config;
    ...
    .line 8
    sget-object v2, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->e:[Landroid/graphics/Bitmap$Config;

    goto :goto_0

    .line 9
    :cond_0
    sget-object v2, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$a;->a:[I
    ...
    .line 10
    :cond_1
    sget-object v2, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->h:[Landroid/graphics/Bitmap$Config;

    goto :goto_0

    .line 11
    :cond_2
    sget-object v2, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->g:[Landroid/graphics/Bitmap$Config;

    goto :goto_0

    .line 12
    :cond_3
    sget-object v2, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->f:[Landroid/graphics/Bitmap$Config;

    goto :goto_0

    .line 13
    :cond_4
    sget-object v2, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->d:[Landroid/graphics/Bitmap$Config;
    ...
    .line 15
    invoke-virtual {p0, v5}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->c(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
    ...
    invoke-virtual {v0, v1}, Lo4/b;->c(Lo4/e;)V
    ...
    invoke-virtual {v0, v1, v5}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$c;->d(ILandroid/graphics/Bitmap$Config;)Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$b;
    ...
    :cond_8
    :goto_3
    iget-object v0, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->b:Lo4/c;

    invoke-virtual {v0, v1}, Lo4/c;->a(Lo4/e;)Ljava/lang/Object;
    ...
    .line 23
    iget v1, v1, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$b;->b:I
...
.method public put(Landroid/graphics/Bitmap;)V
    ...
    invoke-virtual {v1, v0, v2}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$c;->d(ILandroid/graphics/Bitmap$Config;)Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy$b;

    move-result-object v0

    .line 3
    iget-object v1, p0, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->b:Lo4/c;

    invoke-virtual {v1, v0, p1}, Lo4/c;->b(Lo4/e;Ljava/lang/Object;)V
    ...
    invoke-virtual {p0, p1}, Lcom/bumptech/glide/load/engine/bitmap_recycle/SizeConfigStrategy;->c(Landroid/graphics/Bitmap$Config;)Ljava/util/NavigableMap;
