...
.method public static constructor <clinit>()V
    ...
    invoke-direct {v1, v3, v4}, Lcom/newrelic/agent/android/api/v1/DeviceForm;-><init>(Ljava/lang/String;I)V
    ...
    invoke-direct {v3, v5, v6}, Lcom/newrelic/agent/android/api/v1/DeviceForm;-><init>(Ljava/lang/String;I)V

    sput-object v3, Lcom/newrelic/agent/android/api/v1/DeviceForm;->NORMAL:Lcom/newrelic/agent/android/api/v1/DeviceForm;

    .line 4
    new-instance v5, Lcom/newrelic/agent/android/api/v1/DeviceForm;

    const-string v7, "LARGE"

    const/4 v8, 0x3

    invoke-direct {v5, v7, v8}, Lcom/newrelic/agent/android/api/v1/DeviceForm;-><init>(Ljava/lang/String;I)V

    sput-object v5, Lcom/newrelic/agent/android/api/v1/DeviceForm;->LARGE:Lcom/newrelic/agent/android/api/v1/DeviceForm;

    .line 5
    new-instance v7, Lcom/newrelic/agent/android/api/v1/DeviceForm;

    const-string v9, "XLARGE"

    const/4 v10, 0x4

    invoke-direct {v7, v9, v10}, Lcom/newrelic/agent/android/api/v1/DeviceForm;-><init>(Ljava/lang/String;I)V

    sput-object v7, Lcom/newrelic/agent/android/api/v1/DeviceForm;->XLARGE:Lcom/newrelic/agent/android/api/v1/DeviceForm;

    const/4 v9, 0x5

    new-array v9, v9, [Lcom/newrelic/agent/android/api/v1/DeviceForm;
    ...
    .line 6
    sput-object v9, Lcom/newrelic/agent/android/api/v1/DeviceForm;->$VALUES:[Lcom/newrelic/agent/android/api/v1/DeviceForm;
