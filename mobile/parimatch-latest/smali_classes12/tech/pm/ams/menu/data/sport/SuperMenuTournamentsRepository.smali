.class public final Ltech/pm/ams/menu/data/sport/SuperMenuTournamentsRepository;
...
.method public constructor <init>(Ltech/pm/ams/common/contracts/SportContract;)V
    ...
    .line 2
    iput-object p1, p0, Ltech/pm/ams/menu/data/sport/SuperMenuTournamentsRepository;->a:Ltech/pm/ams/common/contracts/SportContract;
...
# virtual methods
.method public final getTournaments(Ljava/util/List;)Lkotlinx/coroutines/flow/Flow;
    .locals 5
    ...
    .line 2
    sget-object v0, Ltech/pm/ams/menu/data/sport/SuperMenuTournamentsRepository$b;->d:Ltech/pm/ams/menu/data/sport/SuperMenuTournamentsRepository$b;
    ...
    .line 5
    sget-object v0, Ltech/pm/ams/menu/data/sport/SuperMenuTournamentsRepository$c;->d:Ltech/pm/ams/menu/data/sport/SuperMenuTournamentsRepository$c;
    ...
    check-cast v2, Ltech/pm/pmcommon/customscheme/CustomSchemeOpenEvent$Tournament;
    ...
    .line 10
    :cond_1
    invoke-virtual {v2}, Ltech/pm/pmcommon/customscheme/CustomSchemeOpenEvent$Tournament;->getTournamentKeyString()Ljava/lang/String;

    move-result-object v2

    invoke-static {v2}, Ltech/pm/ams/common/extentions/EventsKt;->getValidTournamentKey(Ljava/lang/String;)Lpm/tech/sport/codegen/TournamentKey;
    ...
    .line 12
    :cond_2
    iget-object p1, p0, Ltech/pm/ams/menu/data/sport/SuperMenuTournamentsRepository;->a:Ltech/pm/ams/common/contracts/SportContract;

    invoke-virtual {v0}, Ljava/util/HashMap;->keySet()Ljava/util/Set;

    move-result-object v0

    const-string v1, "tournamentKeysMap.keys"
    ...
    invoke-interface {p1, v0}, Ltech/pm/ams/common/contracts/SportContract;->getTournamentsFlow(Ljava/util/List;)Lkotlinx/coroutines/flow/Flow;

    move-result-object p1

    .line 13
    new-instance v0, Ltech/pm/ams/menu/data/sport/SuperMenuTournamentsRepository$a;

    invoke-direct {v0, v2}, Ltech/pm/ams/menu/data/sport/SuperMenuTournamentsRepository$a;-><init>(Lkotlin/coroutines/Continuation;)V
