.class final Lj$/time/format/DateTimeFormatterBuilder$g;
...
.method public b(Lj$/time/format/h;Ljava/lang/StringBuilder;)Z
    ...
    invoke-virtual {v2, v1}, Lj$/time/format/h;->e(Lj$/time/temporal/TemporalField;)Ljava/lang/Long;

    move-result-object v1

    invoke-virtual/range {p1 .. p1}, Lj$/time/format/h;->d()Lj$/time/temporal/TemporalAccessor;

    move-result-object v3

    sget-object v4, Lj$/time/temporal/ChronoField;->NANO_OF_SECOND:Lj$/time/temporal/ChronoField;

    invoke-interface {v3, v4}, Lj$/time/temporal/TemporalAccessor;->c(Lj$/time/temporal/TemporalField;)Z
    ...
    invoke-interface {v2, v4}, Lj$/time/temporal/TemporalAccessor;->i(Lj$/time/temporal/TemporalField;)J
    ...
    :goto_1
    invoke-virtual {v4, v1, v2}, Lj$/time/temporal/ChronoField;->p(J)I
    ...
    invoke-static {v5, v6, v3, v7}, Lj$/time/LocalDateTime;->z(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
    ...
    invoke-static {v7, v8, v3, v13}, Lj$/time/LocalDateTime;->z(JILj$/time/ZoneOffset;)Lj$/time/LocalDateTime;
...
.method public d(Lj$/time/format/e;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v1, v2}, Lj$/time/format/DateTimeFormatterBuilder;->a(Lj$/time/format/DateTimeFormatter;)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-virtual {v1, v7, v3, v0, v8}, Lj$/time/format/DateTimeFormatterBuilder;->b(Lj$/time/temporal/TemporalField;IIZ)Lj$/time/format/DateTimeFormatterBuilder;
    ...
    invoke-virtual {v0, v3}, Lj$/time/format/DateTimeFormatter;->g(Z)Lj$/time/format/DateTimeFormatterBuilder$d;

    move-result-object v0

    invoke-virtual/range {p1 .. p1}, Lj$/time/format/e;->d()Lj$/time/format/e;

    move-result-object v1

    move-object/from16 v9, p2

    invoke-virtual {v0, v1, v9, v6}, Lj$/time/format/DateTimeFormatterBuilder$d;->d(Lj$/time/format/e;Ljava/lang/CharSequence;I)I
    ...
    invoke-virtual {v1, v0}, Lj$/time/format/e;->j(Lj$/time/temporal/TemporalField;)Ljava/lang/Long;
    ...
    invoke-virtual {v1, v2}, Lj$/time/format/e;->j(Lj$/time/temporal/TemporalField;)Ljava/lang/Long;
    ...
    invoke-virtual {v1, v5}, Lj$/time/format/e;->j(Lj$/time/temporal/TemporalField;)Ljava/lang/Long;
    ...
    invoke-virtual {v1, v4}, Lj$/time/format/e;->j(Lj$/time/temporal/TemporalField;)Ljava/lang/Long;

    move-result-object v4

    invoke-virtual {v1, v7}, Lj$/time/format/e;->j(Lj$/time/temporal/TemporalField;)Ljava/lang/Long;
    ...
    invoke-virtual/range {p1 .. p1}, Lj$/time/format/e;->p()V
    ...
    :try_start_0
    invoke-static/range {v12 .. v18}, Lj$/time/LocalDateTime;->x(IIIIIII)Lj$/time/LocalDateTime;
    ...
    invoke-static {v10, v11, v2, v3}, Lj$/lang/d;->e(JJ)J
