...
# instance fields
.field private final a:Lj$/util/stream/v2;
...
.field private final e:Lj$/util/stream/i3;

.field private final f:Lj$/util/stream/q0;

.field private g:Lj$/util/stream/x1;
...
.method constructor <init>(Lj$/util/stream/q0;Lj$/util/Spliterator;Lj$/util/stream/q0;)V
    ...
    iget-object v0, p1, Lj$/util/stream/q0;->a:Lj$/util/stream/v2;

    iput-object v0, p0, Lj$/util/stream/q0;->a:Lj$/util/stream/v2;
    ...
    iget-object p1, p1, Lj$/util/stream/q0;->e:Lj$/util/stream/i3;

    iput-object p1, p0, Lj$/util/stream/q0;->e:Lj$/util/stream/i3;
...
.method protected constructor <init>(Lj$/util/stream/v2;Lj$/util/Spliterator;Lj$/util/stream/i3;)V
    .locals 2
    ...
    iput-object p1, p0, Lj$/util/stream/q0;->a:Lj$/util/stream/v2;
    ...
    iput-object p3, p0, Lj$/util/stream/q0;->e:Lj$/util/stream/i3;
...
.method public final compute()V
    ...
    iget-object v2, v4, Lj$/util/stream/q0;->a:Lj$/util/stream/v2;

    invoke-virtual {v2, v0}, Lj$/util/stream/v2;->l0(Lj$/util/Spliterator;)J

    move-result-wide v5

    invoke-virtual {v2, v5, v6, v1}, Lj$/util/stream/v2;->o0(JLj$/util/function/IntFunction;)Lj$/util/stream/p1;
    ...
    .line 3
    invoke-virtual {v2, v1}, Lj$/util/stream/c;->q0(Lj$/util/stream/i3;)Lj$/util/stream/i3;

    move-result-object v3

    invoke-virtual {v2, v3, v0}, Lj$/util/stream/c;->i0(Lj$/util/stream/i3;Lj$/util/Spliterator;)V
    ...
    iput-object v0, v4, Lj$/util/stream/q0;->g:Lj$/util/stream/x1;
...
.method public onCompletion(Ljava/util/concurrent/CountedCompleter;)V
    ...
    iget-object p1, p0, Lj$/util/stream/q0;->g:Lj$/util/stream/x1;

    const/4 v0, 0x0

    if-eqz p1, :cond_0

    iget-object v1, p0, Lj$/util/stream/q0;->e:Lj$/util/stream/i3;

    invoke-interface {p1, v1}, Lj$/util/stream/x1;->forEach(Lj$/util/function/Consumer;)V

    iput-object v0, p0, Lj$/util/stream/q0;->g:Lj$/util/stream/x1;
    ...
    iget-object v1, p0, Lj$/util/stream/q0;->a:Lj$/util/stream/v2;

    iget-object v2, p0, Lj$/util/stream/q0;->e:Lj$/util/stream/i3;
    ...
    .line 2
    invoke-virtual {v1, v2}, Lj$/util/stream/c;->q0(Lj$/util/stream/i3;)Lj$/util/stream/i3;

    move-result-object v2

    invoke-virtual {v1, v2, p1}, Lj$/util/stream/c;->i0(Lj$/util/stream/i3;Lj$/util/Spliterator;)V
