...
.field private final b:Lj$/util/stream/i3;

.field private final c:Lj$/util/stream/v2;
...
.method constructor <init>(Lj$/util/stream/r0;Lj$/util/Spliterator;)V
    ...
    iget-object p2, p1, Lj$/util/stream/r0;->b:Lj$/util/stream/i3;

    iput-object p2, p0, Lj$/util/stream/r0;->b:Lj$/util/stream/i3;

    iget-wide v0, p1, Lj$/util/stream/r0;->d:J

    iput-wide v0, p0, Lj$/util/stream/r0;->d:J

    iget-object p1, p1, Lj$/util/stream/r0;->c:Lj$/util/stream/v2;

    iput-object p1, p0, Lj$/util/stream/r0;->c:Lj$/util/stream/v2;

    return-void
.end method

.method constructor <init>(Lj$/util/stream/v2;Lj$/util/Spliterator;Lj$/util/stream/i3;)V
    .locals 1
    ...
    iput-object p3, p0, Lj$/util/stream/r0;->b:Lj$/util/stream/i3;
...
.method public compute()V
    ...
    iget-object v6, p0, Lj$/util/stream/r0;->c:Lj$/util/stream/v2;

    invoke-virtual {v6}, Lj$/util/stream/v2;->n0()I

    move-result v6

    invoke-virtual {v5, v6}, Lj$/util/stream/Z3;->h(I)Z

    move-result v5

    const/4 v6, 0x0

    iget-object v7, p0, Lj$/util/stream/r0;->b:Lj$/util/stream/i3;
    ...
    invoke-interface {v7}, Lj$/util/stream/i3;->o()Z
    ...
    :cond_4
    :goto_2
    iget-object v1, v8, Lj$/util/stream/r0;->c:Lj$/util/stream/v2;

    invoke-virtual {v1, v7, v0}, Lj$/util/stream/v2;->i0(Lj$/util/stream/i3;Lj$/util/Spliterator;)V
