...
.method private synthetic constructor <init>(Lj$/util/stream/Stream;)V
    ...
    iput-object p1, p0, Lj$/wrappers/u;->a:Lj$/util/stream/Stream;

    return-void
.end method

.method public static synthetic i0(Lj$/util/stream/Stream;)Ljava/util/stream/Stream;
    .locals 1
    ...
    invoke-direct {v0, p0}, Lj$/wrappers/u;-><init>(Lj$/util/stream/Stream;)V
...
.method public synthetic allMatch(Ljava/util/function/Predicate;)Z
    ...
    iget-object v0, p0, Lj$/wrappers/u;->a:Lj$/util/stream/Stream;
...
.method public synthetic collect(Ljava/util/function/Supplier;Ljava/util/function/BiConsumer;Ljava/util/function/BiConsumer;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/wrappers/i;->w(Ljava/util/function/BiConsumer;)Lj$/util/function/BiConsumer;
    ...
    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->l(Lj$/util/function/Supplier;Lj$/util/function/BiConsumer;Lj$/util/function/BiConsumer;)Ljava/lang/Object;
...
.method public synthetic collect(Ljava/util/stream/Collector;)Ljava/lang/Object;
    ...
    invoke-static {p1}, Lj$/wrappers/q;->e(Ljava/util/stream/Collector;)Lj$/util/stream/Collector;
...
.method public synthetic findAny()Ljava/util/Optional;
    ...
    invoke-static {v0}, Lj$/util/k;->i(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public synthetic flatMap(Ljava/util/function/Function;)Ljava/util/stream/Stream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->q(Lj$/util/function/Function;)Lj$/util/stream/Stream;
...
.method public synthetic flatMapToDouble(Ljava/util/function/Function;)Ljava/util/stream/DoubleStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->A(Lj$/util/function/Function;)Lj$/util/stream/DoubleStream;
...
.method public synthetic flatMapToInt(Ljava/util/function/Function;)Ljava/util/stream/IntStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->f(Lj$/util/function/Function;)Lj$/util/stream/IntStream;
...
.method public synthetic flatMapToLong(Ljava/util/function/Function;)Ljava/util/stream/LongStream;
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->T(Lj$/util/function/Function;)Lj$/util/stream/LongStream;
...
.method public synthetic forEachOrdered(Ljava/util/function/Consumer;)V
    ...
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->h(Lj$/util/function/Consumer;)V
...
.method public synthetic mapToDouble(Ljava/util/function/ToDoubleFunction;)Ljava/util/stream/DoubleStream;
    ...
    .line 2
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->c0(Lj$/util/function/ToDoubleFunction;)Lj$/util/stream/DoubleStream;
...
.method public synthetic mapToInt(Ljava/util/function/ToIntFunction;)Ljava/util/stream/IntStream;
    ...
    .line 2
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->o(Lj$/util/function/ToIntFunction;)Lj$/util/stream/IntStream;
...
.method public synthetic mapToLong(Ljava/util/function/ToLongFunction;)Ljava/util/stream/LongStream;
    ...
    .line 2
    :goto_0
    invoke-interface {v0, p1}, Lj$/util/stream/Stream;->Z(Lj$/util/function/ToLongFunction;)Lj$/util/stream/LongStream;
...
.method public synthetic max(Ljava/util/Comparator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/util/k;->i(Lj$/util/Optional;)Ljava/util/Optional;
...
.method public synthetic reduce(Ljava/lang/Object;Ljava/util/function/BiFunction;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p3}, Lj$/wrappers/i;->x(Ljava/util/function/BinaryOperator;)Lj$/util/function/b;

    move-result-object p3

    invoke-interface {v0, p1, p2, p3}, Lj$/util/stream/Stream;->y(Ljava/lang/Object;Lj$/util/function/BiFunction;Lj$/util/function/b;)Ljava/lang/Object;
...
.method public synthetic reduce(Ljava/lang/Object;Ljava/util/function/BinaryOperator;)Ljava/lang/Object;
    ...
    invoke-static {p2}, Lj$/wrappers/i;->x(Ljava/util/function/BinaryOperator;)Lj$/util/function/b;

    move-result-object p2

    invoke-interface {v0, p1, p2}, Lj$/util/stream/Stream;->h0(Ljava/lang/Object;Lj$/util/function/b;)Ljava/lang/Object;
...
.method public synthetic reduce(Ljava/util/function/BinaryOperator;)Ljava/util/Optional;
    ...
    invoke-static {p1}, Lj$/wrappers/i;->x(Ljava/util/function/BinaryOperator;)Lj$/util/function/b;
