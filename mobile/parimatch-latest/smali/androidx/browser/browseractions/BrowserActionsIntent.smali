...
.method public static launchIntent(Landroid/content/Context;Landroid/content/Intent;)V
    ...
    :cond_3
    :goto_1
    invoke-static {p0, p1, v1}, Landroidx/core/content/ContextCompat;->startActivity(Landroid/content/Context;Landroid/content/Intent;Landroid/os/Bundle;)V
    ...
    invoke-direct {v2, p0, v0, p1}, Lj/e;-><init>(Landroid/content/Context;Landroid/net/Uri;Ljava/util/List;)V
    ...
    invoke-direct {v0, v2, v4}, Lj/d;-><init>(Lj/e;Landroid/widget/TextView;)V

    invoke-virtual {v4, v0}, Landroid/widget/TextView;->setOnClickListener(Landroid/view/View$OnClickListener;)V

    .line 24
    sget v0, Landroidx/browser/R$id;->browser_actions_menu_items:I
    ...
    iget-object v5, v2, Lj/e;->f:Ljava/util/List;

    invoke-direct {v4, v5, p0}, Lj/a;-><init>(Ljava/util/List;Landroid/content/Context;)V
    ...
    .line 28
    invoke-direct {v1, p0, v3}, Lj/b;-><init>(Landroid/content/Context;Landroid/view/View;)V

    iput-object v1, v2, Lj/e;->g:Lj/b;

    .line 29
    invoke-virtual {v1, p1}, Landroid/app/Dialog;->setContentView(Landroid/view/View;)V

    .line 30
    iget-object p0, v2, Lj/e;->g:Lj/b;

    invoke-virtual {p0}, Lj/b;->show()V
