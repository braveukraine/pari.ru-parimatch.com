...
.method public connect(Landroid/net/Uri;Ljava/util/Set;Ljava/util/concurrent/Executor;)Lcom/google/common/util/concurrent/ListenableFuture;
    ...
    invoke-direct {p1, v0}, Ll/a;-><init>(Ll/b;)V
    ...
    .line 4
    invoke-virtual {p0, v0, p1, p2, v1}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
    ...
    invoke-direct {v1, p0, p1}, Ll/f;-><init>(Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;Landroid/net/Uri;)V

    invoke-direct {v0, v1}, Ll/b;-><init>(Ljava/lang/Runnable;)V
    ...
    invoke-direct {p1, v1, p2, v0}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool$a;-><init>(Landroid/content/Context;Landroid/content/Intent;Ll/b;)V
...
.method public serviceExistsForScope(Landroid/net/Uri;Ljava/util/Set;)Z
    ...
    invoke-virtual {p0, v0, p1, p2, v2}, Landroidx/browser/trusted/TrustedWebActivityServiceConnectionPool;->a(Landroid/content/Context;Landroid/net/Uri;Ljava/util/Set;Z)Landroid/content/Intent;
