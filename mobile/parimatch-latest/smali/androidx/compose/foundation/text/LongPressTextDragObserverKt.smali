...
# direct methods
.method public static final access$detectDragGesturesWithObserver(Landroidx/compose/ui/input/pointer/PointerInputScope;Landroidx/compose/foundation/text/TextDragObserver;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 6

    .line 1
    new-instance v1, Lz/g;

    invoke-direct {v1, p1}, Lz/g;-><init>(Landroidx/compose/foundation/text/TextDragObserver;)V

    new-instance v2, Lz/h;

    invoke-direct {v2, p1}, Lz/h;-><init>(Landroidx/compose/foundation/text/TextDragObserver;)V

    new-instance v3, Lz/i;

    invoke-direct {v3, p1}, Lz/i;-><init>(Landroidx/compose/foundation/text/TextDragObserver;)V

    new-instance v4, Lz/j;

    invoke-direct {v4, p1}, Lz/j;-><init>(Landroidx/compose/foundation/text/TextDragObserver;)V
...
.method public static final access$detectPreDragGesturesWithObserver(Landroidx/compose/ui/input/pointer/PointerInputScope;Landroidx/compose/foundation/text/TextDragObserver;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    .locals 2
    ...
    invoke-direct {v0, p1, v1}, Lz/k;-><init>(Landroidx/compose/foundation/text/TextDragObserver;Lkotlin/coroutines/Continuation;)V
