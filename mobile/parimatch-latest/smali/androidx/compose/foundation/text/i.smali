...
.method public constructor <init>(Landroidx/compose/ui/text/input/OffsetMapping;ZLandroidx/compose/ui/text/input/TextFieldValue;Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;Landroidx/compose/foundation/text/TextFieldState;)V
    ...
    iput-object p1, p0, Landroidx/compose/foundation/text/i;->$offsetMapping:Landroidx/compose/ui/text/input/OffsetMapping;

    iput-boolean p2, p0, Landroidx/compose/foundation/text/i;->$enabled:Z

    iput-object p3, p0, Landroidx/compose/foundation/text/i;->$value:Landroidx/compose/ui/text/input/TextFieldValue;

    iput-object p4, p0, Landroidx/compose/foundation/text/i;->$manager:Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;

    iput-object p5, p0, Landroidx/compose/foundation/text/i;->$state:Landroidx/compose/foundation/text/TextFieldState;
...
.method public invoke(Ljava/lang/Object;Ljava/lang/Object;Ljava/lang/Object;)Ljava/lang/Object;
    ...
    .line 2
    :cond_0
    iget-object v0, p0, Landroidx/compose/foundation/text/i;->$offsetMapping:Landroidx/compose/ui/text/input/OffsetMapping;
    ...
    .line 4
    :goto_1
    iget-boolean v0, p0, Landroidx/compose/foundation/text/i;->$enabled:Z
    ...
    .line 5
    :cond_2
    iget-object v0, p0, Landroidx/compose/foundation/text/i;->$value:Landroidx/compose/ui/text/input/TextFieldValue;
    ...
    .line 6
    :cond_3
    invoke-static {p1, p2}, Lmf/e;->coerceAtMost(II)I
    ...
    .line 7
    invoke-static {p1, p2}, Lmf/e;->coerceAtLeast(II)I

    move-result v0

    iget-object v2, p0, Landroidx/compose/foundation/text/i;->$value:Landroidx/compose/ui/text/input/TextFieldValue;
    ...
    .line 8
    :cond_4
    iget-object p3, p0, Landroidx/compose/foundation/text/i;->$manager:Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;
    ...
    .line 10
    :goto_3
    iget-object p3, p0, Landroidx/compose/foundation/text/i;->$state:Landroidx/compose/foundation/text/TextFieldState;
    ...
    .line 16
    :cond_6
    iget-object p1, p0, Landroidx/compose/foundation/text/i;->$manager:Landroidx/compose/foundation/text/selection/TextFieldSelectionManager;
