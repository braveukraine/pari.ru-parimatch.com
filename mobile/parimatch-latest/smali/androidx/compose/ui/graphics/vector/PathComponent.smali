...
.field public c:Landroidx/compose/ui/graphics/Brush;
...
.field public i:Landroidx/compose/ui/graphics/Brush;
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
.end field
...
.field public s:Landroidx/compose/ui/graphics/drawscope/Stroke;
    .annotation build Lorg/jetbrains/annotations/Nullable;
    .end annotation
.end field
...
.field public final u:Landroidx/compose/ui/graphics/Path;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.field public final w:Landroidx/compose/ui/graphics/vector/PathParser;
    .annotation build Lorg/jetbrains/annotations/NotNull;
    .end annotation
.end field
...
.method public constructor <init>()V
    ...
    .line 13
    iput-boolean v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->r:Z
    ...
    sget-object v1, Landroidx/compose/ui/graphics/vector/PathComponent$a;->d:Landroidx/compose/ui/graphics/vector/PathComponent$a;
    ...
    iput-object v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->w:Landroidx/compose/ui/graphics/vector/PathParser;
...
.method public final b()V
    ...
    .line 3
    iget-object v5, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->u:Landroidx/compose/ui/graphics/Path;

    iget-object v6, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->t:Landroidx/compose/ui/graphics/Path;
    ...
    .line 4
    :cond_2
    invoke-virtual {p0}, Landroidx/compose/ui/graphics/vector/PathComponent;->a()Landroidx/compose/ui/graphics/PathMeasure;

    move-result-object v0

    iget-object v5, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->t:Landroidx/compose/ui/graphics/Path;
    ...
    iget v5, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->o:F
    ...
    .line 7
    iget v6, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->n:F
...
.method public draw(Landroidx/compose/ui/graphics/drawscope/DrawScope;)V
    ...
    .line 2
    iget-object v1, v0, Landroidx/compose/ui/graphics/vector/PathComponent;->w:Landroidx/compose/ui/graphics/vector/PathParser;

    invoke-virtual {v1}, Landroidx/compose/ui/graphics/vector/PathParser;->clear()V

    .line 3
    iget-object v1, v0, Landroidx/compose/ui/graphics/vector/PathComponent;->t:Landroidx/compose/ui/graphics/Path;
    ...
    iget-object v2, v0, Landroidx/compose/ui/graphics/vector/PathComponent;->e:Ljava/util/List;

    invoke-virtual {v1, v2}, Landroidx/compose/ui/graphics/vector/PathParser;->addPathNodes(Ljava/util/List;)Landroidx/compose/ui/graphics/vector/PathParser;

    move-result-object v1

    iget-object v2, v0, Landroidx/compose/ui/graphics/vector/PathComponent;->t:Landroidx/compose/ui/graphics/Path;

    invoke-virtual {v1, v2}, Landroidx/compose/ui/graphics/vector/PathParser;->toPath(Landroidx/compose/ui/graphics/Path;)Landroidx/compose/ui/graphics/Path;

    .line 5
    invoke-virtual/range {p0 .. p0}, Landroidx/compose/ui/graphics/vector/PathComponent;->b()V
    ...
    .line 11
    :goto_1
    iget-object v4, v0, Landroidx/compose/ui/graphics/vector/PathComponent;->i:Landroidx/compose/ui/graphics/Brush;
...
.method public final getFillAlpha()F
    ...
    .line 1
    iget v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->d:F
...
.method public final getName()Ljava/lang/String;
    ...
    .line 1
    iget-object v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->b:Ljava/lang/String;
...
.method public final getPathFillType-Rg-k1Os()I
    ...
    .line 1
    iget v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->f:I
...
.method public final getStrokeAlpha()F
    ...
    .line 1
    iget v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->g:F
...
.method public final getStrokeLineCap-KaPHkGw()I
    ...
    .line 1
    iget v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->j:I
...
.method public final getStrokeLineJoin-LxFBmk8()I
    ...
    .line 1
    iget v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->k:I
...
.method public final getStrokeLineWidth()F
    ...
    .line 1
    iget v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->h:F
...
.method public final getTrimPathOffset()F
    ...
    .line 1
    iget v0, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->o:F
...
.method public final setTrimPathEnd(F)V
    ...
    .line 3
    iput-boolean v1, p0, Landroidx/compose/ui/graphics/vector/PathComponent;->r:Z
