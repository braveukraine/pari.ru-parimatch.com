...
.method public constructor <init>(Landroidx/recyclerview/widget/DiffUtil$Callback;Ljava/util/List;[I[IZ)V
    ...
    check-cast p4, Landroidx/recyclerview/widget/DiffUtil$b;

    :goto_0
    if-eqz p4, :cond_1

    .line 12
    iget p5, p4, Landroidx/recyclerview/widget/DiffUtil$b;->a:I

    if-nez p5, :cond_1

    iget p4, p4, Landroidx/recyclerview/widget/DiffUtil$b;->b:I

    if-eqz p4, :cond_2

    .line 13
    :cond_1
    new-instance p4, Landroidx/recyclerview/widget/DiffUtil$b;

    invoke-direct {p4, v0, v0, v0}, Landroidx/recyclerview/widget/DiffUtil$b;-><init>(III)V
    ...
    invoke-direct {p4, p3, p1, v0}, Landroidx/recyclerview/widget/DiffUtil$b;-><init>(III)V
    ...
    check-cast p2, Landroidx/recyclerview/widget/DiffUtil$b;

    const/4 p3, 0x0

    .line 16
    :goto_1
    iget p4, p2, Landroidx/recyclerview/widget/DiffUtil$b;->c:I

    if-ge p3, p4, :cond_3

    .line 17
    iget p4, p2, Landroidx/recyclerview/widget/DiffUtil$b;->a:I

    add-int/2addr p4, p3

    .line 18
    iget p5, p2, Landroidx/recyclerview/widget/DiffUtil$b;->b:I
    ...
    .line 23
    iget-object p1, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->a:Ljava/util/List;
    ...
    check-cast p3, Landroidx/recyclerview/widget/DiffUtil$b;

    .line 24
    :goto_4
    iget p4, p3, Landroidx/recyclerview/widget/DiffUtil$b;->a:I

    if-ge p2, p4, :cond_a

    .line 25
    iget-object p4, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->b:[I
    ...
    .line 26
    iget-object p4, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->a:Ljava/util/List;
    ...
    .line 31
    iget-object p4, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->d:Landroidx/recyclerview/widget/DiffUtil$Callback;
    ...
    .line 33
    iget-object p5, p0, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->c:[I
    ...
    .line 34
    :cond_8
    iget v1, v2, Landroidx/recyclerview/widget/DiffUtil$b;->c:I
    ...
    .line 35
    :cond_a
    iget p2, p3, Landroidx/recyclerview/widget/DiffUtil$b;->c:I
...
.method public static a(Ljava/util/Collection;IZ)Landroidx/recyclerview/widget/DiffUtil$c;
    .locals 2
    ...
    .line 4
    iget v1, v0, Landroidx/recyclerview/widget/DiffUtil$c;->a:I

    if-ne v1, p1, :cond_0

    iget-boolean v1, v0, Landroidx/recyclerview/widget/DiffUtil$c;->c:Z
    ...
    .line 8
    iget v1, p1, Landroidx/recyclerview/widget/DiffUtil$c;->b:I

    add-int/lit8 v1, v1, -0x1

    iput v1, p1, Landroidx/recyclerview/widget/DiffUtil$c;->b:I
...
.method public dispatchUpdatesTo(Landroidx/recyclerview/widget/ListUpdateCallback;)V
    ...
    check-cast v6, Landroidx/recyclerview/widget/DiffUtil$b;

    .line 11
    iget v7, v6, Landroidx/recyclerview/widget/DiffUtil$b;->a:I

    iget v8, v6, Landroidx/recyclerview/widget/DiffUtil$b;->c:I

    add-int/2addr v7, v8

    .line 12
    iget v9, v6, Landroidx/recyclerview/widget/DiffUtil$b;->b:I
    ...
    .line 14
    invoke-static {v1, v11, v8}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->a(Ljava/util/Collection;IZ)Landroidx/recyclerview/widget/DiffUtil$c;
    ...
    .line 15
    iget v8, v8, Landroidx/recyclerview/widget/DiffUtil$c;->b:I
    ...
    invoke-direct {v8, v2, v10, v5}, Landroidx/recyclerview/widget/DiffUtil$c;-><init>(IIZ)V
    ...
    .line 22
    invoke-static {v1, v10, v5}, Landroidx/recyclerview/widget/DiffUtil$DiffResult;->a(Ljava/util/Collection;IZ)Landroidx/recyclerview/widget/DiffUtil$c;
    ...
    .line 23
    new-instance v7, Landroidx/recyclerview/widget/DiffUtil$c;

    sub-int v10, v0, v2

    invoke-direct {v7, v3, v10, v8}, Landroidx/recyclerview/widget/DiffUtil$c;-><init>(IIZ)V
    ...
    .line 24
    :cond_5
    iget v11, v11, Landroidx/recyclerview/widget/DiffUtil$c;->b:I
    ...
    .line 29
    :cond_7
    iget v2, v6, Landroidx/recyclerview/widget/DiffUtil$b;->a:I

    .line 30
    iget v3, v6, Landroidx/recyclerview/widget/DiffUtil$b;->b:I

    .line 31
    :goto_4
    iget v7, v6, Landroidx/recyclerview/widget/DiffUtil$b;->c:I
