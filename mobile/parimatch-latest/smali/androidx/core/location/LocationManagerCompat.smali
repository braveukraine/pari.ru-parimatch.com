...
.method public static a(Landroid/location/LocationManager;Landroid/os/Handler;Ljava/util/concurrent/Executor;Landroidx/core/location/GnssStatusCompat$Callback;)Z
    ...
    .line 8
    iput-object v4, v3, Landroidx/core/location/LocationManagerCompat$i;->c:Ljava/util/concurrent/Executor;

    .line 9
    :goto_1
    iget-object v4, v3, Landroidx/core/location/LocationManagerCompat$i;->c:Ljava/util/concurrent/Executor;
    ...
    .line 10
    iput-object p2, v3, Landroidx/core/location/LocationManagerCompat$i;->c:Ljava/util/concurrent/Executor;
    ...
    invoke-direct {v4, p0, v3}, Lc2/f;-><init>(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$i;)V
...
.method public static b(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$l;)V
    .locals 3
    .annotation build Landroidx/annotation/GuardedBy;
        value = "sLocationListeners"
    .end annotation
    ...
    .line 2
    iget-object v1, p1, Landroidx/core/location/LocationManagerCompat$l;->a:Landroidx/core/location/LocationManagerCompat$k;

    invoke-static {v1}, Landroidx/core/util/ObjectsCompat;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v1

    check-cast v1, Landroidx/core/location/LocationManagerCompat$k;
    ...
    .line 5
    iput-object v0, p1, Landroidx/core/location/LocationManagerCompat$l;->a:Landroidx/core/location/LocationManagerCompat$k;
...
.method public static getCurrentLocation(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/os/CancellationSignal;Ljava/util/concurrent/Executor;Landroidx/core/util/Consumer;)V
    ...
    invoke-direct {p0, p4, v0, p1}, Lc2/e;-><init>(Landroidx/core/util/Consumer;Landroid/location/Location;I)V
    ...
    invoke-direct {p0, v0}, Lc2/d;-><init>(Landroidx/core/location/LocationManagerCompat$f;)V
    ...
    .line 12
    :try_start_0
    iget-boolean p2, v0, Landroidx/core/location/LocationManagerCompat$f;->e:Z
    ...
    invoke-direct {p2, v0}, Lc2/h;-><init>(Landroidx/core/location/LocationManagerCompat$f;)V

    iput-object p2, v0, Landroidx/core/location/LocationManagerCompat$f;->f:Ljava/lang/Runnable;

    .line 15
    iget-object p3, v0, Landroidx/core/location/LocationManagerCompat$f;->c:Landroid/os/Handler;
...
.method public static removeUpdates(Landroid/location/LocationManager;Landroidx/core/location/LocationListenerCompat;)V
    ...
    check-cast v4, Landroidx/core/location/LocationManagerCompat$l;
    ...
    .line 4
    :cond_1
    iget-object v5, v4, Landroidx/core/location/LocationManagerCompat$l;->a:Landroidx/core/location/LocationManagerCompat$k;

    invoke-static {v5}, Landroidx/core/util/ObjectsCompat;->requireNonNull(Ljava/lang/Object;)Ljava/lang/Object;

    move-result-object v5

    check-cast v5, Landroidx/core/location/LocationManagerCompat$k;

    .line 5
    iget-object v6, v5, Landroidx/core/location/LocationManagerCompat$k;->b:Landroidx/core/location/LocationListenerCompat;
    ...
    .line 8
    iput-object v2, v4, Landroidx/core/location/LocationManagerCompat$l;->a:Landroidx/core/location/LocationManagerCompat$k;
    ...
    .line 11
    sget-object v3, Landroidx/core/location/LocationManagerCompat;->a:Ljava/util/WeakHashMap;
...
.method public static requestLocationUpdates(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Ljava/util/concurrent/Executor;Landroidx/core/location/LocationListenerCompat;)V
    ...
    new-instance v1, Landroidx/core/location/LocationManagerCompat$k;

    invoke-direct {v1, p1, p4}, Landroidx/core/location/LocationManagerCompat$k;-><init>(Ljava/lang/String;Landroidx/core/location/LocationListenerCompat;)V

    invoke-direct {v0, v1, p3}, Landroidx/core/location/LocationManagerCompat$l;-><init>(Landroidx/core/location/LocationManagerCompat$k;Ljava/util/concurrent/Executor;)V

    .line 6
    invoke-static {p0, p1, p2, v0}, Landroidx/core/location/LocationManagerCompat$a;->b(Landroid/location/LocationManager;Ljava/lang/String;Landroidx/core/location/LocationRequestCompat;Landroidx/core/location/LocationManagerCompat$l;)Z
    ...
    .line 7
    :cond_2
    sget-object p3, Landroidx/core/location/LocationManagerCompat;->a:Ljava/util/WeakHashMap;
    ...
    .line 12
    invoke-static {p0, v0}, Landroidx/core/location/LocationManagerCompat;->b(Landroid/location/LocationManager;Landroidx/core/location/LocationManagerCompat$l;)V
...
.method public static unregisterGnssStatusCallback(Landroid/location/LocationManager;Landroidx/core/location/GnssStatusCompat$Callback;)V
    ...
    .line 8
    iput-object v1, p1, Landroidx/core/location/LocationManagerCompat$i;->c:Ljava/util/concurrent/Executor;
