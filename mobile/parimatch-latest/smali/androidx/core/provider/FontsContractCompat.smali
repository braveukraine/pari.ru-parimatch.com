...
.method public static fetchFonts(Landroid/content/Context;Landroid/os/CancellationSignal;Landroidx/core/provider/FontRequest;)Landroidx/core/provider/FontsContractCompat$FontFamilyResult;
    ...
    .line 1
    invoke-static {p0, p2, p1}, Landroidx/core/provider/d;->a(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroid/os/CancellationSignal;)Landroidx/core/provider/FontsContractCompat$FontFamilyResult;
...
.method public static getProvider(Landroid/content/pm/PackageManager;Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
    ...
    .line 1
    invoke-static {p0, p1, p2}, Landroidx/core/provider/d;->b(Landroid/content/pm/PackageManager;Landroidx/core/provider/FontRequest;Landroid/content/res/Resources;)Landroid/content/pm/ProviderInfo;
...
.method public static requestFont(Landroid/content/Context;Landroidx/core/provider/FontRequest;IZILandroid/os/Handler;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;)Landroid/graphics/Typeface;
    ...
    .line 5
    sget-object p3, Landroidx/core/provider/f;->a:Landroidx/collection/LruCache;
    ...
    .line 7
    iget-object v2, p1, Landroidx/core/provider/FontRequest;->f:Ljava/lang/String;
    ...
    .line 9
    sget-object v2, Landroidx/core/provider/f;->a:Landroidx/collection/LruCache;

    invoke-virtual {v2, p3}, Landroidx/collection/LruCache;->get(Ljava/lang/Object;)Ljava/lang/Object;
    ...
    invoke-direct {p0, v0, p6, v2}, Landroidx/core/provider/a;-><init>(Landroidx/core/provider/c;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;Landroid/graphics/Typeface;)V
    ...
    .line 11
    invoke-static {p3, p0, p1, p2}, Landroidx/core/provider/f;->a(Ljava/lang/String;Landroid/content/Context;Landroidx/core/provider/FontRequest;I)Landroidx/core/provider/f$d;

    move-result-object p0

    .line 12
    invoke-virtual {v0, p0}, Landroidx/core/provider/c;->a(Landroidx/core/provider/f$d;)V

    .line 13
    iget-object v1, p0, Landroidx/core/provider/f$d;->a:Landroid/graphics/Typeface;

    goto :goto_0

    .line 14
    :cond_1
    new-instance p5, Landroidx/core/provider/e;

    invoke-direct {p5, p3, p0, p1, p2}, Landroidx/core/provider/e;-><init>(Ljava/lang/String;Landroid/content/Context;Landroidx/core/provider/FontRequest;I)V
    ...
    .line 18
    :try_start_2
    check-cast p0, Landroidx/core/provider/f$d;
    ...
    .line 25
    iget-object p2, v0, Landroidx/core/provider/c;->b:Landroid/os/Handler;

    new-instance p3, Landroidx/core/provider/b;

    invoke-direct {p3, v0, p1, p0}, Landroidx/core/provider/b;-><init>(Landroidx/core/provider/c;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;I)V
    ...
    .line 26
    :cond_2
    invoke-static {p0, p1, p2, v1, v0}, Landroidx/core/provider/f;->b(Landroid/content/Context;Landroidx/core/provider/FontRequest;ILjava/util/concurrent/Executor;Landroidx/core/provider/c;)Landroid/graphics/Typeface;
...
.method public static requestFont(Landroid/content/Context;Landroidx/core/provider/FontRequest;Landroidx/core/provider/FontsContractCompat$FontRequestCallback;Landroid/os/Handler;)V
    ...
    invoke-direct {p2, p3}, Le2/d;-><init>(Landroid/os/Handler;)V
    ...
    invoke-static {p0, p1, p3, p2, v0}, Landroidx/core/provider/f;->b(Landroid/content/Context;Landroidx/core/provider/FontRequest;ILjava/util/concurrent/Executor;Landroidx/core/provider/c;)Landroid/graphics/Typeface;
