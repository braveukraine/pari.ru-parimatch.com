...
# instance fields
.field public b:Landroidx/lifecycle/BlockRunner;
    .annotation system Ldalvik/annotation/Signature;
        value = {
...
.field public c:Landroidx/lifecycle/EmittedSource;
...
.method public constructor <init>(Lkotlin/coroutines/CoroutineContext;JLkotlin/jvm/functions/Function2;)V
    ...
    .line 7
    new-instance v6, Landroidx/lifecycle/CoroutineLiveData$a;

    invoke-direct {v6, p0}, Landroidx/lifecycle/CoroutineLiveData$a;-><init>(Landroidx/lifecycle/CoroutineLiveData;)V
...
.method public static final synthetic access$getBlockRunner$p(Landroidx/lifecycle/CoroutineLiveData;)Landroidx/lifecycle/BlockRunner;
    ...
    .line 1
    iget-object p0, p0, Landroidx/lifecycle/CoroutineLiveData;->b:Landroidx/lifecycle/BlockRunner;
...
.method public final clearSource$lifecycle_livedata_ktx_release(Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v0, p1, Landroidx/lifecycle/CoroutineLiveData$b;
    ...
    iget v1, v0, Landroidx/lifecycle/CoroutineLiveData$b;->label:I
    ...
    iput v1, v0, Landroidx/lifecycle/CoroutineLiveData$b;->label:I
    ...
    invoke-direct {v0, p0, p1}, Landroidx/lifecycle/CoroutineLiveData$b;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p1, v0, Landroidx/lifecycle/CoroutineLiveData$b;->result:Ljava/lang/Object;
    ...
    .line 1
    iget v2, v0, Landroidx/lifecycle/CoroutineLiveData$b;->label:I
    ...
    iget-object v0, v0, Landroidx/lifecycle/CoroutineLiveData$b;->L$0:Ljava/lang/Object;
    ...
    iput-object p0, v0, Landroidx/lifecycle/CoroutineLiveData$b;->L$0:Ljava/lang/Object;

    iput v3, v0, Landroidx/lifecycle/CoroutineLiveData$b;->label:I
    ...
    .line 6
    iput-object p1, v0, Landroidx/lifecycle/CoroutineLiveData;->c:Landroidx/lifecycle/EmittedSource;
...
.method public final emitSource$lifecycle_livedata_ktx_release(Landroidx/lifecycle/LiveData;Lkotlin/coroutines/Continuation;)Ljava/lang/Object;
    ...
    instance-of v0, p2, Landroidx/lifecycle/CoroutineLiveData$c;

    if-eqz v0, :cond_0

    move-object v0, p2

    check-cast v0, Landroidx/lifecycle/CoroutineLiveData$c;

    iget v1, v0, Landroidx/lifecycle/CoroutineLiveData$c;->label:I
    ...
    iput v1, v0, Landroidx/lifecycle/CoroutineLiveData$c;->label:I

    goto :goto_0

    :cond_0
    new-instance v0, Landroidx/lifecycle/CoroutineLiveData$c;

    invoke-direct {v0, p0, p2}, Landroidx/lifecycle/CoroutineLiveData$c;-><init>(Landroidx/lifecycle/CoroutineLiveData;Lkotlin/coroutines/Continuation;)V

    :goto_0
    iget-object p2, v0, Landroidx/lifecycle/CoroutineLiveData$c;->result:Ljava/lang/Object;
    ...
    .line 1
    iget v2, v0, Landroidx/lifecycle/CoroutineLiveData$c;->label:I
    ...
    iget-object p1, v0, Landroidx/lifecycle/CoroutineLiveData$c;->L$1:Ljava/lang/Object;

    check-cast p1, Landroidx/lifecycle/LiveData;

    iget-object p1, v0, Landroidx/lifecycle/CoroutineLiveData$c;->L$0:Ljava/lang/Object;
    ...
    iget-object v2, v0, Landroidx/lifecycle/CoroutineLiveData$c;->L$0:Ljava/lang/Object;
    ...
    .line 4
    iput-object p0, v0, Landroidx/lifecycle/CoroutineLiveData$c;->L$0:Ljava/lang/Object;

    iput-object p1, v0, Landroidx/lifecycle/CoroutineLiveData$c;->L$1:Ljava/lang/Object;

    iput v4, v0, Landroidx/lifecycle/CoroutineLiveData$c;->label:I
    ...
    .line 5
    :goto_1
    iput-object p1, v0, Landroidx/lifecycle/CoroutineLiveData$c;->L$0:Ljava/lang/Object;

    iput-object p2, v0, Landroidx/lifecycle/CoroutineLiveData$c;->L$1:Ljava/lang/Object;

    iput v3, v0, Landroidx/lifecycle/CoroutineLiveData$c;->label:I
