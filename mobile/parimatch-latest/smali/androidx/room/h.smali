...
.field public final i:Landroidx/sqlite/db/SupportSQLiteOpenHelper;
    .annotation build Landroidx/annotation/NonNull;
    .end annotation
.end field

.field public j:Landroidx/room/DatabaseConfiguration;
    .annotation build Landroidx/annotation/Nullable;
    .end annotation
.end field
...
.method public constructor <init>(Landroid/content/Context;Ljava/lang/String;Ljava/io/File;Ljava/util/concurrent/Callable;ILandroidx/sqlite/db/SupportSQLiteOpenHelper;)V
    ...
    .line 2
    iput-object p1, p0, Landroidx/room/h;->d:Landroid/content/Context;

    .line 3
    iput-object p2, p0, Landroidx/room/h;->e:Ljava/lang/String;

    .line 4
    iput-object p3, p0, Landroidx/room/h;->f:Ljava/io/File;

    .line 5
    iput-object p4, p0, Landroidx/room/h;->g:Ljava/util/concurrent/Callable;

    .line 6
    iput p5, p0, Landroidx/room/h;->h:I

    .line 7
    iput-object p6, p0, Landroidx/room/h;->i:Landroidx/sqlite/db/SupportSQLiteOpenHelper;
...
.method public final a(Ljava/io/File;Z)V
    ...
    .line 2
    iget-object v0, p0, Landroidx/room/h;->d:Landroid/content/Context;
    ...
    .line 3
    :cond_0
    iget-object v0, p0, Landroidx/room/h;->f:Ljava/io/File;
    ...
    iget-object v1, p0, Landroidx/room/h;->f:Ljava/io/File;
    ...
    .line 5
    :cond_1
    iget-object v0, p0, Landroidx/room/h;->g:Ljava/util/concurrent/Callable;
    ...
    .line 8
    :goto_0
    iget-object v1, p0, Landroidx/room/h;->d:Landroid/content/Context;
    ...
    :cond_3
    :goto_1
    iget-object v0, p0, Landroidx/room/h;->j:Landroidx/room/DatabaseConfiguration;
    ...
    .line 21
    iget-object v3, p0, Landroidx/room/h;->d:Landroid/content/Context;
    ...
    invoke-direct {v4, p0, v0}, Lw2/h0;-><init>(Landroidx/room/h;I)V
    ...
    .line 28
    :goto_2
    iget-object v2, p0, Landroidx/room/h;->j:Landroidx/room/DatabaseConfiguration;
    ...
    invoke-virtual {v2, p2}, Landroidx/room/RoomDatabase$PrepackagedDatabaseCallback;->onOpenPrepackagedDatabase(Landroidx/sqlite/db/SupportSQLiteDatabase;)V
    :try_end_2
...
.method public final b(Z)V
    ...
    .line 1
    invoke-virtual {p0}, Landroidx/room/h;->getDatabaseName()Ljava/lang/String;

    move-result-object v1

    .line 2
    iget-object v2, p0, Landroidx/room/h;->d:Landroid/content/Context;
    ...
    .line 3
    iget-object v3, p0, Landroidx/room/h;->j:Landroidx/room/DatabaseConfiguration;
    ...
    iget-object v5, p0, Landroidx/room/h;->d:Landroid/content/Context;
    ...
    .line 7
    :try_start_1
    invoke-virtual {p0, v2, p1}, Landroidx/room/h;->a(Ljava/io/File;Z)V
    :try_end_1
    .catch Ljava/io/IOException; {:try_start_1 .. :try_end_1} :catch_0
    ...
    .line 13
    :try_start_4
    iget v6, p0, Landroidx/room/h;->h:I
    :try_end_4
    ...
    :cond_4
    :try_start_5
    iget-object v7, p0, Landroidx/room/h;->j:Landroidx/room/DatabaseConfiguration;
...
.method public declared-synchronized close()V
    ...
    .line 1
    :try_start_0
    iget-object v0, p0, Landroidx/room/h;->i:Landroidx/sqlite/db/SupportSQLiteOpenHelper;
    ...
    .line 2
    iput-boolean v0, p0, Landroidx/room/h;->k:Z
    :try_end_0
    .catchall {:try_start_0 .. :try_end_0} :catchall_0
...
.method public declared-synchronized getReadableDatabase()Landroidx/sqlite/db/SupportSQLiteDatabase;
    ...
    .line 1
    :try_start_0
    iget-boolean v0, p0, Landroidx/room/h;->k:Z
    ...
    .line 2
    invoke-virtual {p0, v0}, Landroidx/room/h;->b(Z)V
