...
.method public a(Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Bundle;Landroid/os/Messenger;)V
    ...
    .line 5
    invoke-virtual {p0, p1, v0, p4}, Landroid/support/v4/media/MediaBrowserCompat$g;->e(ILandroid/os/Bundle;Landroid/os/Messenger;)V

    return-void
.end method

.method public b(Ljava/lang/String;Landroid/os/IBinder;Landroid/os/Messenger;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
    ...
    .line 4
    invoke-virtual {p0, p1, v0, p3}, Landroid/support/v4/media/MediaBrowserCompat$g;->e(ILandroid/os/Bundle;Landroid/os/Messenger;)V

    return-void
.end method

.method public c(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
...
.method public d(Ljava/lang/String;Landroid/os/Bundle;Landroid/support/v4/os/ResultReceiver;Landroid/os/Messenger;)V
    .locals 2
    .annotation system Ldalvik/annotation/Throws;
        value = {
            Landroid/os/RemoteException;
